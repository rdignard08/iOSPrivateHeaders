...
// RestGoatee
#define COCOAPODS_POD_AVAILABLE_RestGoatee
#define COCOAPODS_VERSION_MAJOR_RestGoatee 2
#define COCOAPODS_VERSION_MINOR_RestGoatee 3
#define COCOAPODS_VERSION_PATCH_RestGoatee 0
