...
@interface AFURLConnectionOperation : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSSecureCoding, NSCopying> {
 ...
 - (void) connection:(id)a willSendRequestForAuthenticationChallenge:(id)b ;
 - (id) connection:(id)a willSendRequest:(id)b redirectResponse:(id)c ;
 - (void) connection:(id)a didReceiveResponse:(id)b ;
 - (void) connection:(id)a didReceiveData:(id)b ;
 - (void) connectionDidFinishLoading:(id)a ;
 - (id) connection:(id)a willCacheResponse:(id)b ;
 - (void) connection:(id)a didSendBodyData:(long long)b totalBytesWritten:(long long)c totalBytesExpectedToWrite:(long long)d ;
