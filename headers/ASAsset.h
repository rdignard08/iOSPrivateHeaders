...
@property (nonatomic, retain, readwrite) NSDictionary* downloadOptions;
 ...
 - (BOOL) requiredDiskSpaceIsAvailableForDownloadOptions:(id)a requiredBytes:(^q)b error:(^@)c ;
 - (void) setDownloadOptions:(id)a ;
 - (@?) progressHandler;
 - (void) _downloadWithOptions:(id)a shouldFireCallback:(BOOL)b ;
 ...
 - (BOOL) requiredDiskSpaceIsAvailable:(^q)a error:(^@)b ;
 - (void) adjustDownloadOptions:(id)a completion:(@?)b ;
 - (void) cancelDownload:(@?)a ;
 - (void) purge:(@?)a ;
 - (id) assetType;
 - (id) downloadOptions;
 - (id) initWithAssetType:(id)a attributes:(id)b ;
 - (id) clientName;
