...
@property (nonatomic, assign, readwrite) NSNumber* originalImageSize;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) rectWithSize:({CGSize=dd})aandPoint:({CGPoint=dd})binPosition:(i)cfromOriginalSize:({CGSize=dd})d;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) scaleRect:({CGRect={CGPoint=dd}{CGSize=dd}})atoFitSize:({CGSize=dd})bwithAnchorPoint:({CGPoint=dd})c;
 - (i) determineBestPositionWithinSize:({CGSize=dd})aforImportantRect:({CGRect={CGPoint=dd}{CGSize=dd}})brestrictRect:({CGRect={CGPoint=dd}{CGSize=dd}})c;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) scaleRect:({CGRect={CGPoint=dd}{CGSize=dd}})abyScale:(d)b;
 ...
 - (i) getRatioOfSize:({CGSize=dd})a;
 - (id) clusterRects:(id)a;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) computeClippingWithinSize:({CGSize=dd})aandImportantRects:(id)b;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) computeClippingWithinSize:({CGSize=dd})aforImportantRect:({CGRect={CGPoint=dd}{CGSize=dd}})bandType:(i)crestrictRect:({CGRect={CGPoint=dd}{CGSize=dd}})d;
