...
@property (nonatomic, copy, readwrite) NSArray* interestedBundleIDs;
 ...
 - (void) setHandler:(@?)a ;
 - (id) bundleInfoValueForKey:(id)a PID:(int)b ;
 - (unsigned int) applicationStateForApplication:(id)a ;
 - (unsigned int) mostElevatedApplicationStateForPID:(int)a ;
 - (void) applicationInfoForPID:(int)a completion:(@?)b ;
 - (void) applicationInfoForApplication:(id)a completion:(@?)b ;
 - (id) initWithBundleIDs:(id)a states:(unsigned int)b ;
 - (id) initWithEndpoint:(id)a bundleIDs:(id)b states:(unsigned int)c ;
 ...
 - (void) updateInterestedBundleIDs:(id)a states:(unsigned int)b ;
