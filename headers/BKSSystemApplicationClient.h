...
@interface BKSSystemApplicationClient : BSBaseXPCClient {
 ...
 - (void) _connect;
 - (void) _sendMessageOfType:(long long)a packer:(@?)b replyHandler:(@?)c waitForReply:(BOOL)d waitDuration:(unsigned long long)e ;
 - (void) _sendMessageOfType:(long long)a packer:(@?)b ;
 - (void) _queue_handleWatchdogPing:(id)a ;
 - (void) _sendMessageOfType:(long long)a packer:(@?)b replyHandler:(@?)c ;
