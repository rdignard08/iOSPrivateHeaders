...
@property (nonatomic, retain, readwrite) BSEventQueueEvent* executingEvent;
 ...
 - (void) _noteWillPendEvents:(id)aatPosition:(int)b;
 - (void) _processNextEvent;
 - (void) executeOrInsertEvents:(id)aatPosition:(int)b;
 - (void) _executeOrPendEvents:(id)aposition:(int)b;
 - (id) acquireLockForReason:(id)a;
 - (void) _noteWillExecuteEvent:(id)a;
 - (void) flushEvents:(id)a;
 - (void) _noteWillCancelEventsWithName:(id)acount:(unsigned long long)b;
 - (void) setExecutingEvent:(id)a;
 - (void) relinquishLock:(id)a;
 - (void) _noteQueueDidLock;
 - (void) _noteQueueDidUnlock;
 - (id) initWithName:(id)aonQueue:(id)b;
 - (void) executeOrInsertEvent:(id)aatPosition:(int)b;
 - (id) pendingEvents;
