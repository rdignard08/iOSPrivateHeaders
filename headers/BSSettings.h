...
@property (nonatomic, weak, readwrite) NSNumber* descriptionProvider;
 ...
 - (void) _setFlag:(long long)a forSetting:(unsigned long long)b ;
 - (void) _setObject:(id)a forSetting:(unsigned long long)b ;
 - (void) _enumerateSettingsInMap:(id)a withBlock:(@?)b ;
 - (id) _keyDescriptionForSetting:(unsigned long long)a ;
 - (id) _valueDescriptionForFlag:(long long)a object:(id)b ofSetting:(unsigned long long)c ;
 - (id) _newMapTable;
