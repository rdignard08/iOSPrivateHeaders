...
@property (atomic, copy, readwrite) NSString* fillMode;
 ...
 - (void) setPerspectiveDistance:(d)a;
 ...
 - (void) setRasterizationScale:(d)a;
 - (void) insertSublayer:(id)aatIndex:(I)b;
 ...
 - (void) insertState:(id)aatIndex:(I)b;
 - (void) addState:(id)a;
 ...
 - (id) sublayers;
 - (id) mask;
 - (d) convertTime:(d)afromLayer:(id)b;
 ...
 - (BOOL) acceptsLights;
 - (d) ambientReflectance;
 - (d) diffuseReflectance;
 - (d) specularReflectance;
 - (d) shininess;
 - (d) metallicity;
 - (d) velocityStretch;
 - (d) momentOfInertia;
 - (d) coefficientOfRestitution;
 - (BOOL) preloadsCache;
 ...
 - (void) setAmbientReflectance:(d)a;
 - (void) setDiffuseReflectance:(d)a;
 - (void) setSpecularReflectance:(d)a;
 - (void) setShininess:(d)a;
 - (void) setMetallicity:(d)a;
 - (void) setVelocityStretch:(d)a;
 - (void) setMomentOfInertia:(d)a;
 - (void) setCoefficientOfRestitution:(d)a;
 - (BOOL) getRendererInfo:(^{_CARenderRendererInfo=iII})asize:(Q)b;
 ...
 - (void) setOpacity:(f)a;
 - (void) setEdgeAntialiasingMask:(I)a;
