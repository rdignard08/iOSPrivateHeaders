...
@property (atomic, assign, readonly) NSNumber* subdivisionSteps;
 ...
 - (id) initWithVertexCount:(unsigned long long)a vertices:(r^{CAMeshVertex={CGPoint=dd}{CAPoint3D=ddd}})b faceCount:(unsigned long long)c faces:(r^{CAMeshFace=[4I][4f]})d depthNormalization:(id)e ;
