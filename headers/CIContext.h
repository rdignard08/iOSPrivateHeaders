...
@interface CIContext : NSObject {
 ...
 + (i) _crashed_because_nonaddressable_memory_was_passed_to_render:(id)atoBitmap:(^v)browBytes:(q)cbounds:({CGRect={CGPoint=dd}{CGSize=dd}})dformat:(i)ecolorSpace:(^{CGColorSpace=})f;
 ...
 - (void) unlock;
 - (id) init;
 - (void) render:(id)atoBitmap:(^v)browBytes:(q)cbounds:({CGRect={CGPoint=dd}{CGSize=dd}})dformat:(i)ecolorSpace:(^{CGColorSpace=})f;
 ...
 - (^{CGImage=}) createCGImage:(id)afromRect:({CGRect={CGPoint=dd}{CGSize=dd}})bformat:(i)ccolorSpace:(^{CGColorSpace=})d;
 ...
 - (void) render:(id)atoTexture:(I)bbounds:({CGRect={CGPoint=dd}{CGSize=dd}})ccolorSpace:(^{CGColorSpace=})d;
 - (^{CGImage=}) createCGImage:(id)afromRect:({CGRect={CGPoint=dd}{CGSize=dd}})b;
 - (^{CGImage=}) createCGImage:(id)afromRect:({CGRect={CGPoint=dd}{CGSize=dd}})bformat:(i)c;
 - (Q) maximumInputImageSize;
 - (Q) maximumOutputImageSize;
 - ({CGSize=dd}) inputImageMaximumSize;
 - ({CGSize=dd}) outputImageMaximumSize;
 - (id) createColorCubeDataForFilters:(id)adimension:(i)b;
