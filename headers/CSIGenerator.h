...
@property (nonatomic, copy, readwrite) NSDate* modtime;
 ...
 - (void) _addNodes:(id)a toNodeList:(^{_csigradientdatanode=Ifdddddddd})b ;
 - (void) formatCSIHeader:(^{_csiheader=IIIIIIIb4b28{_csimetadata=ISS[128c]}I{_csibitmaplist=I[0I]}})a ;
 - (void) writeHeader:(^{_csiheader=IIIIIIIb4b28{_csimetadata=ISS[128c]}I{_csibitmaplist=I[0I]}})a toData:(id)b ;
 ...
 - (unsigned long long) writeBitmap:(id)a toData:(id)b compress:(BOOL)c ;
 - (id) initWithCanvasSize:({CGSize=dd})a sliceCount:(unsigned int)b layout:(short)c ;
 - (id) initWithShapeEffectPreset:(id)a forScaleFactor:(unsigned int)b ;
 - (id) initWithRawData:(id)a pixelFormat:(unsigned int)b layout:(short)c ;
 - (void) addBitmap:(id)a ;
