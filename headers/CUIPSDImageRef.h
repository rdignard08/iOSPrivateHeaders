...
@interface CUIPSDImageRef : NSObject {
 ...
 - (id) _imageAtAbsoluteIndex:(unsigned int)aisZeroSizeImage:(^B)b;
 - (id) _imageFromSlice:(unsigned int)aatAbsoluteIndex:(unsigned int)bisEmptyImage:(^B)c;
 - (id) _patternFromSlice:(unsigned int)aatAbsoluteIndex:(unsigned int)bisZeroSizeImage:(^B)c;
 - (id) _createMaskFromSlice:(unsigned int)aatAbsoluteIndex:(unsigned int)b;
 ...
 - (int) _layerIndexFromLayerNames:(id)aindexRangeBegin:(int)bindexRangeEnd:(int)cisTopLevel:(BOOL)d;
 ...
 - (id) _copySublayerInfoAtAbsoluteIndex:(unsigned int)aatRoot:(BOOL)b;
 ...
 - (id) imageAtLayer:(unsigned int)aisZeroSizeImage:(^B)b;
 - (id) imageFromSlice:(unsigned int)aatLayer:(unsigned int)b;
 - (id) imageFromSlice:(unsigned int)aatAbsoluteLayer:(unsigned int)b;
 - (id) imageFromSlice:(unsigned int)aatLayer:(unsigned int)bisEmptyImage:(^B)c;
 - (id) patternFromSlice:(unsigned int)aatLayer:(unsigned int)b;
 - (id) patternFromSlice:(unsigned int)aatLayer:(unsigned int)bisZeroSizeImage:(^B)c;
 - (id) maskFromSlice:(unsigned int)aatLayer:(unsigned int)b;
 - (id) compositeImage;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) boundsForSlice:(unsigned int)a;
 - (int) absoluteLayerIndexFromLayerNames:(id)a;
 - ({?={CGSize=dd}{CGSize=dd}{CGSize=dd}}) metricsInAlphaChannel:(long long)aforRect:({CGRect={CGPoint=dd}{CGSize=dd}})b;
