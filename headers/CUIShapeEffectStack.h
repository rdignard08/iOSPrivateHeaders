...
@property (atomic, assign, readonly) NSNumber* outputBlendMode;
 ...
 - (id) processedImageFromShapeImage:(id)awithScale:(double)b;
 ...
 - (void) _setShapeOpacityFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _setOutputOpacityFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _setColorFillFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _setInteriorGradientFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _addInnerGlowFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _addInnerShadowFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _addOuterGlowFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _addEngraveShadowFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _addBevelEmbossFromPreset:(id)aatIndex:(unsigned int)b;
 - (void) _addExtraShadowFromPreset:(id)aatIndex:(unsigned int)b;
 ...
 - (id) compositeEffectStackWithShapeImage:(id)awithScale:(double)b;
 - (^{CGImage=}) newFlattenedImageFromShapeCGImage:(^{CGImage=})awithScale:(double)b;
 ...
 - (^{CGImage=}) newFlattenedImageFromShapeCGImage:(^{CGImage=})awithScale:(double)bciContext:(id)c;
