...
@interface CUIThemeSchema : NSObject {
 ...
 - (r^{?=**[5{_renditionkeytoken=SS}]qq[12{?=**qQ}]}) partDefinitionWithName:(id)a forElementDefinition:(r^{?=**Bq[7{?=**[5{_renditionkeytoken=SS}]qq[12{?=**qQ}]}]})b ;
 ...
 - (void) enumerateAvailableThemeAttributesInPartDefinition:(r^{?=**[5{_renditionkeytoken=SS}]qq[12{?=**qQ}]})a usingBlock:(@?)b ;
 - (void) enumerateAvailableValuesForThemeAttribute:(int)a inPartDefinition:(r^{?=**[5{_renditionkeytoken=SS}]qq[12{?=**qQ}]})b usingBlock:(@?)c ;
