...
@interface DOMDocument : DOMNode {
 ...
 - (id) createElementNS:(id)aqualifiedName:(id)b;
 ...
 - (id) createProcessingInstruction:(id)adata:(id)b;
 - (id) createProcessingInstruction:(id)a;
 - (id) createAttribute:(id)a;
 - (id) createEntityReference:(id)a;
 - (id) importNode:(id)adeep:(BOOL)b;
 - (id) importNode:(id)a;
 - (id) createAttributeNS:(id)aqualifiedName:(id)b;
