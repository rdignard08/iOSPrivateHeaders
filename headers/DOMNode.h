...
@interface DOMNode : DOMObject <DOMEventTarget, UIKeyboardInput, UITextInputPrivate, UIKeyInput, UITextInputTokenizer, UIWebSelectionBlock, UITextInput_Internal> {
 ...
 - (id) asElement;
 - (id) firstDescendantOfAboutTheSameWidthOrHeightAsRect:({CGRect={CGPoint=dd}{CGSize=dd}})awithDescentDirection:(int)b;
 ...
 - ({CGPoint=dd}) constrainedPoint:({CGPoint=dd})awithInset:(double)b;
 - (void) setSelectionWithPoint:({CGPoint=dd})ainset:(double)b;
