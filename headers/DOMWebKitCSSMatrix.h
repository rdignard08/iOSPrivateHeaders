...
@interface DOMWebKitCSSMatrix : DOMObject {
 ...
 - (id) multiply:(id)a;
 - (id) inverse;
 - (id) translate:(double)ay:(double)bz:(double)c;
 - (id) scale:(double)ascaleY:(double)bscaleZ:(double)c;
 - (id) rotate:(double)arotY:(double)brotZ:(double)c;
 - (id) rotateAxisAngle:(double)ay:(double)bz:(double)cangle:(double)d;
 - (id) skewX:(double)a;
 - (id) skewY:(double)a;
 - (id) toString;
