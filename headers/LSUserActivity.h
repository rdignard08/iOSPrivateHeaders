...
@property (atomic, assign, readwrite) NSNumber* encodedFileProviderURL;
 ...
 - (void) sendUserActivityInfoToLSUserActivityd:(BOOL)a onAsyncQueue:(BOOL)b ;
 ...
 - (id) callWillSaveDelegateIfDirtyAndPackageUpData:(BOOL)a clearDirty:(BOOL)b ;
 - (void) didReceiveInputStream:(id)a outputStream:(id)b ;
 - (id) initWithManager:(id)a userActivityInfo:(id)b ;
 - (void) willSynchronizeUserActivityWithHandler:(@?)a ;
 - (void) didSynchronizeUserActivity;
 - (void) advertiser:(id)a didReceiveInputStream:(id)b outputStream:(id)c ;
 - (id) unarchiver:(id)a didDecodeObject:(id)b ;
 - (id) archiver:(id)a willEncodeObject:(id)b ;
 - (void) resignCurrent;
 - (id) initWithTypeIdentifier:(id)a options:(id)b ;
 - (id) typeIdentifier;
 - (id) title;
 - (void) setTitle:(id)a ;
 ...
 - (id) webPageURL;
 - (void) setWebPageURL:(id)a ;
 - (id) initWithTypeIdentifier:(id)a suggestedActionType:(unsigned long long)b options:(id)c ;
 - (void) updateUserInfoValue:(id)a forKey:(id)b ;
 - (void) removeUserInfoValueForKey:(id)a ;
 - (id) frameworkPayload;
 - (void) setFrameworkPayload:(id)a ;
 - (void) updateFrameworkPayloadValue:(id)a forKey:(id)b ;
