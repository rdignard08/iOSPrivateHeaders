...
@property (atomic, retain, readwrite) NSMapTable* userActivitiesByUUID;
 ...
 - (void) askClientUserActivityToSave:(id)a completionHandler:(@?)b ;
 - (void) tellClientUserActivityItWasResumed:(id)a ;
 - (BOOL) activityContinuationIsEnabled;
 - (void) didReceiveInputStreamWithUUID:(id)a inputStream:(id)b outputStream:(id)c ;
 ...
 - (void) fetchUUID:(id)a withCompletionHandler:(@?)b ;
 - (void) markUserActivityAsDirty:(id)a forceImmediate:(BOOL)b ;
 ...
 - (void) sendUserActivityInfoToLSUserActivityd:(id)a makeCurrent:(BOOL)b ;
 - (id) connection;
 - (void) dealloc;
 - (id) init;
