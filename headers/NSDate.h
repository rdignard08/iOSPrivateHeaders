...
@property (atomic, assign, readonly) NSNumber* timeIntervalSinceReferenceDate;
 ...
 - (BOOL) isEqual:(id)atoUnitGranularity:(unsigned long long)b;
 - (long long) compare:(id)atoUnitGranularity:(unsigned long long)b;
 - (id) initWithTimeInterval:(double)asinceDate:(id)b;
 - (void) encodeWithCoder:(id)a;
 - (id) initWithCoder:(id)a;
 - (id) laterDate:(id)a;
 - (id) earlierDate:(id)a;
