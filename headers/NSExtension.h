...
@property (nonatomic, assign, readwrite) NSNumber* _safePluginQueue;
 ...
 - (void) instantiateViewControllerWithInputItems:(id)a connectionHandler:(@?)b ;
 - (void) instantiateViewControllerWithInputItems:(id)a listenerEndpoint:(id)b connectionHandler:(@?)c ;
 ...
 - (void) beginExtensionRequestWithInputItems:(id)a completion:(@?)b ;
 ...
 - (void) _completeRequestReturningItems:(id)a forExtensionContextWithUUID:(id)b completion:(@?)c ;
 - (void) _cancelRequestWithError:(id)a forExtensionContextWithUUID:(id)b completion:(@?)c ;
 - (void) _loadItemForPayload:(id)a contextIdentifier:(id)b completionHandler:(@?)c ;
 - (void) _loadPreviewImageForPayload:(id)a contextIdentifier:(id)b completionHandler:(@?)c ;
 ...
 - (id) _safePluginQueue;
 - (void) _reallyBeginExtensionRequestWithInputItems:(id)a listenerEndpoint:(id)b completion:(@?)c ;
 - (void) _safelyBeginUsing:(@?)a ;
 - (void) beginExtensionRequestWithInputItems:(id)a listenerEndpoint:(id)b completion:(@?)c ;
 ...
 - (id) _itemProviderForPayload:(id)a extensionContext:(id)b ;
