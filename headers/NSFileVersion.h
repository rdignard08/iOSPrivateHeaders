...
@property (atomic, assign, readonly) NSNumber* hasThumbnail;
 ...
 - (id) _initWithFileURL:(id)a library:(id)b clientID:(id)c name:(id)d contentsURL:(id)e isBackup:(BOOL)f revision:(id)g ;
 ...
 - (id) replaceItemAtURL:(id)a options:(unsigned long long)b error:(^@)c ;
 - (id) _oldReplaceItemAtURL:(id)a options:(unsigned long long)b error:(^@)c ;
