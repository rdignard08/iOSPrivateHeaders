...
@property (atomic, assign, readonly) NSNumber* hasThumbnail;
 ...
 + (void) getNonlocalVersionsOfItemAtURL:(id)aoptions:(Q)bcompletionHandler:(@?)c;
 ...
 + (id) addVersionOfItemAtURL:(id)awithContentsOfURL:(id)boptions:(Q)cerror:(^@)d;
 ...
 + (id) _otherVersionsOfItemAtURL:(id)atemporaryStorageIdentifier:(id)bwithoutOptions:(Q)c;
 + (^{NSObject=#}) _libraryForURL:(id)atemporaryStorageIdentifier:(^@)b;
 + (id) _addVersionOfItemAtURL:(id)awithContentsOfURL:(id)boptions:(Q)cuserInfo:(id)dtemporaryStorageIdentifier:(^@)eerror:(^@)f;
 ...
 + (id) _addVersionOfItemAtURL:(id)awithContentsOfURL:(id)boptions:(Q)ctemporaryStorageIdentifier:(^@)derror:(^@)e;
 ...
 - (id) replaceItemAtURL:(id)aoptions:(Q)berror:(^@)c;
 - (id) _oldReplaceItemAtURL:(id)aoptions:(Q)berror:(^@)c;
