...
@interface NSHTMLReader : NSObject {
    ...
    d _textSizeMultiplier;
    d _webViewTextSizeMultiplier;
 ...
 - (void) _fillInBlock:(id)aforElement:(id)bbackgroundColor:(id)cextraMargin:(d)dextraPadding:(d)eisTable:(BOOL)f;
 ...
 - (void) _traverseNode:(id)adepth:(q)bembedded:(BOOL)c;
 - (void) _newLineForElement:(id)a;
 - (void) _addQuoteForElement:(id)aopening:(BOOL)blevel:(q)c;
 - (void) _addValue:(id)aforElement:(id)b;
 - (void) _newTabForElement:(id)a;
 - (void) _traverseFooterNode:(id)adepth:(q)b;
 - (void) _addMarkersToList:(id)arange:({_NSRange=QQ})b;
 - (BOOL) _enterElement:(id)atag:(id)bdisplay:(id)cdepth:(q)dembedded:(BOOL)e;
 - (BOOL) _processElement:(id)atag:(id)bdisplay:(id)cdepth:(q)d;
 - (void) _exitElement:(id)atag:(id)bdisplay:(id)cdepth:(q)dstartIndex:(Q)e;
