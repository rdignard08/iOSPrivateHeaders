...
@interface NSISEngine : NSObject <NSISVariableDelegate> {
    ...
    i _automaticOptimizationDisabledCount;
    i _engineDelegateCallsDisabledCount;
    i _variableDelegateCallsDisabledCount;
    I _totalChangeCount;
    I _changeCountAtLastOptimization;
...
@property (atomic, assign, readwrite) NSNumber* integralizationAdjustmentsForConstraintMarkers;
 ...
 - (Q) optimize;
 - (BOOL) tryToAddConstraintWithMarker:(id)aexpression:(id)bintegralizationAdjustment:(d)cmutuallyExclusiveConstraints:(^@)d;
 - (void) addVariableToBeOptimized:(id)apriority:(d)b;
 - (void) removeVariableToBeOptimized:(id)apriority:(d)b;
 - (void) changeVariableToBeOptimized:(id)afromPriority:(d)btoPriority:(d)c;
 - (void) removeConstraintWithMarker:(id)a;
 - (void) constraintDidChangeSuchThatMarker:(id)ashouldBeReplacedByMarkerPlusDelta:(d)b;
 - (BOOL) tryToChangeConstraintSuchThatMarker:(id)aisReplacedByMarkerPlusDelta:(d)bundoHandler:(@?)c;
 ...
 - (void) addVariable:(id)acoefficient:(d)btoRowWithHead:(id)cbody:(id)d;
 - (id) rowBodyForObjectiveHead:(id)a;
 - (void) addVariable:(id)apriority:(d)btimes:(d)ctoObjectiveRowWithHead:(id)dbody:(id)e;
 - (void) replaceMarker:(id)awithMarkerPlusCoefficient:(d)btimesVariable:(id)c;
 ...
 - (id) handleUnsatisfiableRowWithHead:(id)abody:(id)busingInfeasibilityHandlingBehavior:(q)cmutuallyExclusiveConstraints:(^@)d;
 - (d) integralizationAdjustmentForMarker:(id)a;
 - (id) variableToWorkOnAmongVariablesWithIntegralizationViolationsIgnoringLostCauses:(id)avarsAlreadyAdjusted:(id)b;
 - (d) valueForVariableWithoutIntegralizationAdjustments:(id)a;
 - (void) setIntegralizationAdjustment:(d)aforMarker:(id)b;
 - (d) valueForVariable:(id)a;
 - (void) withoutOptimizingAtEndRunBlockWithAutomaticOptimizationDisabled:(@?)a;
 - (id) chooseHeadForRowBody:(id)a;
 - (Q) minimizeConstantInObjectiveRowWithHead:(id)a;
 ...
 - (id) fixUpValueRestrictionViolationsWithInfeasibilityHandlingBehavior:(q)a;
 - (void) fixupIntegralizationViolations;
 - (void) _flushPendingRemovals;
 - (void) withBehaviors:(Q)aperformModifications:(@?)b;
 ...
 - (BOOL) tryUsingArtificialVariableToAddConstraintWithMarker:(id)arowBody:(id)busingInfeasibilityHandlingBehavior:(q)cmutuallyExclusiveConstraints:(^@)d;
 - (void) addExpression:(id)apriority:(d)btimes:(d)ctoObjectiveRowWithHead:(id)dbody:(id)e;
 ...
 - (void) _coreReplaceMarker:(id)awithMarkerPlusDelta:(d)b;
 ...
 - (id) allRowHeads;
 - (void) addExpression:(id)atimes:(d)btoRowWithHead:(id)cbody:(id)d;
 - (void) performModifications:(@?)awithUnsatisfiableConstraintsHandler:(@?)b;
 - (Q) numberOfConstraintsEligibleForAdjustmentToIntegralizeVariable:(id)aignoringConstraintsWithMarkers:(id)b;
 - (void) beginRecording;
 - (id) recordedCommandsData;
 - (Q) replayCommandsData:(id)averifyingIntegrity:(BOOL)b;
