...
@property (atomic, assign, readonly) NSNumber* lastIndex;
 ...
 - (id) initWithIndexes:(r^Q)a count:(unsigned long long)b ;
 - (id) _init;
 ...
 - (unsigned long long) _indexClosestToIndex:(unsigned long long)a equalAllowed:(BOOL)b following:(BOOL)c ;
 - (unsigned long long) getIndexes:(^Q)a maxCount:(unsigned long long)b inIndexRange:(^{_NSRange=QQ})c ;
 - (unsigned long long) _indexOfRangeContainingIndex:(unsigned long long)a ;
 - (BOOL) containsIndexesInRange:({_NSRange=QQ})a ;
 - (void) enumerateIndexesWithOptions:(unsigned long long)a usingBlock:(@?)b ;
 - (unsigned long long) indexWithOptions:(unsigned long long)a passingTest:(@?)b ;
 - (id) indexesWithOptions:(unsigned long long)a passingTest:(@?)b ;
 - (void) enumerateRangesWithOptions:(unsigned long long)a usingBlock:(@?)b ;
 ...
 - (void) enumerateIndexesInRange:({_NSRange=QQ})a options:(unsigned long long)b usingBlock:(@?)c ;
 - (unsigned long long) indexPassingTest:(@?)a ;
 - (unsigned long long) indexInRange:({_NSRange=QQ})a options:(unsigned long long)b passingTest:(@?)c ;
 - (id) indexesPassingTest:(@?)a ;
 - (id) indexesInRange:({_NSRange=QQ})a options:(unsigned long long)b passingTest:(@?)c ;
 - (void) enumerateRangesUsingBlock:(@?)a ;
 - (void) enumerateRangesInRange:({_NSRange=QQ})a options:(unsigned long long)b usingBlock:(@?)c ;
 ...
 - (unsigned long long) __getContainmentVector:(o^B)a inRange:({_NSRange=QQ})b ;
 - (id) init;
