...
@property (nonatomic, assign, readwrite, getter=_loweredConstantNeedsUpdate, setter=_setLoweredConstantNeedsUpdate:) NSNumber* loweredConstantNeedsUpdate;
 ...
 - (BOOL) defaultResolvedValue:(^d)a forSymbolicConstant:(id)b error:(^@)c ;
 - (double) multiplier;
 ...
 - (BOOL) _lowerIntoExpression:(id)a reportingConstantIsRounded:(^B)b ;
 - (void) _removeFromEngine:(id)a ;
 - (BOOL) _addLoweredExpression:(id)a toEngine:(id)b integralizationAdjustment:(double)c lastLoweredConstantWasRounded:(BOOL)d mutuallyExclusiveConstraints:(^@)e ;
 ...
 - (BOOL) _effectiveConstant:(^d)a error:(^@)b ;
 - (void) _setSymbolicConstant:(id)a constant:(double)b ;
 - (long long) relation;
 ...
 - (id) _constraintByReplacingItem:(id)a withItem:(id)b ;
 ...
 - (id) symbolicConstant;
 - (id) _constraintByReplacingView:(id)a withView:(id)b ;
