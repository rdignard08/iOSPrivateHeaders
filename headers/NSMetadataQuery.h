...
@property (atomic, copy, readonly) NSArray* groupedResults;
 ...
 - (void) _validatePredicate:(id)a withScopes:(id)b ;
 - (void) _recreateQuery;
 ...
 - (void) _postNotificationName:(id)a userInfo:(id)b ;
 - (void) _update;
 ...
 - (void) enumerateResultsWithOptions:(unsigned long long)a usingBlock:(@?)b ;
 - (void) disableUpdates;
 - (void) enableUpdates;
 - (void) _enableAutoUpdates;
 - (id) valueOfAttribute:(id)a forResultAtIndex:(unsigned long long)b ;
 - (id) sortDescriptors;
