...
@interface NSMutableDictionary : NSDictionary {
 ...
 - (void) _webkit_setInt:(int)aforKey:(id)b;
 - (void) _webkit_setFloat:(float)aforKey:(id)b;
 - (void) _webkit_setBool:(BOOL)aforKey:(id)b;
 - (void) _webkit_setLongLong:(long long)aforKey:(id)b;
 - (void) _webkit_setUnsignedLongLong:(unsigned long long)aforKey:(id)b;
 - (void) _webkit_setUnsignedInt:(unsigned int)aforKey:(id)b;
 ...
 - (void) _web_setInt:(int)aforKey:(id)b;
 ...
 - (void) removeEntriesWithOptions:(unsigned long long)apassingTest:(@?)b;
 - (void) addObjects:(r^@)aforKeys:(r^@)bcount:(unsigned long long)c;
 ...
 - (void) replaceObjects:(r^@)aforKeys:(r^@)bcount:(unsigned long long)c;
 - (void) replaceObjects:(id)aforKeys:(id)b;
 - (void) setEntriesFromDictionary:(id)a;
 - (void) setObjects:(r^@)aforKeys:(r^@)bcount:(unsigned long long)c;
