...
@interface NSObject : nil <NSObject> {
 ...
 + (void) performSelectorWithNonRetainedTarget:(id)aselector:(SEL)bwithObject:(id)cafterDelay:(d)d;
 ...
 + (q) __accessibilityGuidedAccessRestrictionStateForIdentifier:(id)a;
 ...
 + (BOOL) sbs_synchronousWrapper:(@?)adispatchTimeout:(Q)b;
 + (id) sbs_dataFromObject:(id)a;
 + (id) sbs_objectFromData:(id)a;
 + (BOOL) sbs_synchronousWrapper:(@?)a;
 + (BOOL) sbs_synchronousWrapper:(@?)atimeout:(d)b;
 ...
 + (void) bs_waitAsynchronouslyForNotification:(id)aobject:(id)bforDuration:(d)candPerformBlock:(@?)donQueue:(id)e;
 + (id) bs_dataFromObject:(id)a;
 + (BOOL) bs_synchronousWrapper:(@?)atimeout:(d)b;
 ...
 - (void) _nonRetainingPerformSelector:(SEL)awithObject:(id)bafterDelay:(d)cinModes:(id)d;
 - (id) _MPCancellableDispatchAccessQueue;
 - (BOOL) cancelPreviousDispatchAsyncWithCancellationIdentifier:(id)a;
 - (void) dispatchAsyncWithCancellationIdentifier:(id)adelay:(d)bqueue:(id)cblock:(@?)d;
 ...
 - (q) accessibilityNavigationStyle;
 ...
 - (void) setAccessibilityTraits:(Q)a;
 ...
 - (void) setAccessibilityNavigationStyle:(q)a;
 ...
 - (void) performSelector:(SEL)awithObject:(id)bafterDelay:(d)cinModes:(id)d;
 - (void) performSelector:(SEL)awithObject:(id)bafterDelay:(d)c;
 - (void) performSelector:(SEL)aobject:(id)bafterDelay:(d)c;
 ...
 - (void) willChange:(Q)avaluesAtIndexes:(id)bforKey:(id)c;
 - (void) didChange:(Q)avaluesAtIndexes:(id)bforKey:(id)c;
 - (void) willChangeValueForKey:(id)awithSetMutation:(Q)busingObjects:(id)c;
 - (void) didChangeValueForKey:(id)awithSetMutation:(Q)busingObjects:(id)c;
 - (void) willChangeValueForKey:(id)a;
 - (void) didChangeValueForKey:(id)a;
 - (void) _addObserver:(id)aforProperty:(id)boptions:(Q)ccontext:(^v)d;
