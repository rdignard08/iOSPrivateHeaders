...
@interface NSRTFReader : NSObject {
 ...
 - (void) _addListDefinition:(id)a forKey:(long long)b ;
 - (id) _RTFDFileWrapper;
 ...
 - (void) _setCurrentBorderEdge:(unsigned long long)a isTable:(BOOL)b ;
 ...
 - (id) _listDefinitions;
 - (void) _addOverride:(long long)a forKey:(long long)b ;
