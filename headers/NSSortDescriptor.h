...
@property (atomic, retain, readonly) NSNumber* reversedSortDescriptor;
 ...
 - (long long) compareObject:(id)a toObject:(id)b ;
 - (id) initWithKey:(id)a ascending:(BOOL)b selector:(SEL)c ;
 - (id) initWithKey:(id)a ascending:(BOOL)b comparator:(@?)c ;
 - (id) _selectorName;
 - (id) initWithKey:(id)a ascending:(BOOL)b ;
