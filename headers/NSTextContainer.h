...
@property (nonatomic, assign, readwrite) NSNumber* layoutOrientation;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) lineFragmentRectForProposedRect:({CGRect={CGPoint=dd}{CGSize=dd}})a atIndex:(unsigned long long)b writingDirection:(long long)c remainingRect:(^{CGRect={CGPoint=dd}{CGSize=dd}})d ;
