...
@property (atomic, copy, readonly) NSURL* filePathURL;
 ...
 + (id) URLWithDisplayIdentifier:(id)aforSearchResultDomain:(i)bandIdentifier:(Q)c;
 ...
 + (id) URLByResolvingBookmarkData:(id)aoptions:(Q)brelativeToURL:(id)cbookmarkDataIsStale:(^B)derror:(^@)e;
 + (id) URLByResolvingAliasFileAtURL:(id)aoptions:(Q)berror:(^@)c;
 ...
 + (id) __unurl;
 + (BOOL) writeBookmarkData:(id)atoURL:(id)boptions:(Q)cerror:(^@)d;
 ...
 - (id) URLByAppendingQueryParameter:(id)avalue:(id)b;
 ...
 - (void) _domain:(^@)asubdomain:(^@)b;
 - (BOOL) _isGoogleMapsDomain:(id)asubdomain:(id)bpath:(id)cqueryKeysAndValues:(id)d;
 ...
 - (id) ui_issueSandboxExtensionOfClass:(r*)aerror:(^@)b;
 ...
 - (r*) _web_URLCString;
 - (id) _web_URLByTruncatingOneCharacterBeforeComponent:(q)a;
 ...
 - (id) _web_dataForURLComponentType:(q)a;
 ...
 - (q) _promiseExtensionConsume;
 - (void) _promiseExtensionRelease:(q)a;
 - (id) _fixedUpSideFaultError:(id)a;
 - (void) _performWithPhysicalURL:(@?)a;
 - (id) _valueFromFaultDictionary:(id)aforKey:(id)b;
 - (BOOL) checkPromisedItemIsReachableAndReturnError:(^@)a;
 - (id) promisedItemResourceValuesForKeys:(id)aerror:(^@)b;
 - (BOOL) getPromisedItemResourceValue:(o^@)aforKey:(id)berror:(o^@)c;
 - (id) _hostString;
 ...
 - (id) URLByAppendingPathComponent:(id)aisDirectory:(BOOL)b;
 - (id) pathExtension;
 - (id) initFileURLWithPath:(id)aisDirectory:(BOOL)b;
 - (BOOL) getFileSystemRepresentation:(*)amaxLength:(Q)b;
 - (void) _freeClients;
 - (BOOL) _isAbsolute;
 - (id) initWithString:(id)arelativeToURL:(id)b;
 - (id) initFileURLWithFileSystemRepresentation:(r*)aisDirectory:(BOOL)brelativeToURL:(id)c;
 - (id) initByResolvingBookmarkData:(id)aoptions:(Q)brelativeToURL:(id)cbookmarkDataIsStale:(^B)derror:(^@)e;
 - (id) initByResolvingAliasFileAtURL:(id)aoptions:(Q)berror:(^@)c;
 ...
 - (id) absoluteString;
 - (id) initWithScheme:(id)ahost:(id)bpath:(id)c;
 - (r*) fileSystemRepresentation;
 - (id) path;
 - (BOOL) _isSafeFileForBackgroundUpload:(i)a;
 - (BOOL) _isSafeDirectoryForDownloads:(i)a;
 - (BOOL) getResourceValue:(o^@)aforKey:(id)berror:(o^@)c;
 - (id) resourceValuesForKeys:(id)aerror:(^@)b;
 - (id) filePathURL;
 - (id) bookmarkDataWithOptions:(Q)aincludingResourceValuesForKeys:(id)brelativeToURL:(id)cerror:(^@)d;
 - (BOOL) setResourceValues:(id)aerror:(^@)b;
 - (BOOL) checkResourceIsReachableAndReturnError:(^@)a;
 - (id) fileReferenceURL;
 - (BOOL) isFileReferenceURL;
 - (void) removeCachedResourceValueForKey:(id)a;
 - (void) removeAllCachedResourceValues;
 - (void) setTemporaryResourceValue:(id)aforKey:(id)b;
 - (id) bookmarkDataWithAliasRecord:(id)a;
 - (BOOL) startAccessingSecurityScopedResource;
 - (void) stopAccessingSecurityScopedResource;
 - (BOOL) setResourceValue:(id)aforKey:(id)berror:(^@)c;
