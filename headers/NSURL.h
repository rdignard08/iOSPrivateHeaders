...
@property (atomic, copy, readonly) NSURL* filePathURL;
 ...
 - (id) initByResolvingBookmarkData:(id)aoptions:(unsigned long long)brelativeToURL:(id)cbookmarkDataIsStale:(^B)derror:(^@)e;
 - (id) initByResolvingAliasFileAtURL:(id)aoptions:(unsigned long long)berror:(^@)c;
 ...
 - (id) filePathURL;
 - (id) bookmarkDataWithOptions:(unsigned long long)aincludingResourceValuesForKeys:(id)brelativeToURL:(id)cerror:(^@)d;
