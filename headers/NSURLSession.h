...
@property (atomic, copy, readwrite) NSNumber* _connBlock;
 ...
 - (void) delegate_task:(id)aisWaitingForConnectionWithReason:(q)b;
 ...
 - (void) delegate_task:(id)adidSendBodyData:(q)btotalBytesSent:(q)ctotalBytesExpectedToSend:(q)d;
 ...
 - (i) delegate_openFileAtPath:(id)amode:(i)b;
 - (BOOL) can_delegate_downloadTask_didWriteData;
 - (void) delegate_downloadTask:(id)adidWriteData:(q)btotalBytesWritten:(q)ctotalBytesExpectedToWrite:(q)dcompletionHandler:(@?)e;
 ...
 - (void) delegate_downloadTask:(id)adidResumeAtOffset:(q)bexpectedTotalBytes:(q)c;
 - (id) delegateQueue;
 ...
 - (void) delegate_AVAssetDownloadTask:(id)adidReceiveDownloadToken:(Q)b;
 ...
 - (void) delegate_AVAssetDownloadTask:(id)adidWriteData:(q)btotalBytesWritten:(q)ctotalBytesExpectedToWrite:(q)d;
 ...
 - (id) streamTaskForHost:(id)aport:(q)btls:(BOOL)c;
 - (id) streamTaskForHost:(id)aport:(q)btls:(BOOL)ccompletionHandler:(@?)d;
