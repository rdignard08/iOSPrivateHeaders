...
@property (atomic, retain, readonly) LSUserActivity* _internalUserActivity;
 ...
 - (void) didReceiveInputStream:(id)a outputStream:(id)b ;
 - (id) _options;
 ...
 - (id) webPageURL;
 - (void) setWebPageURL:(id)a ;
 - (id) _initWithTypeIdentifier:(id)a suggestedActionType:(unsigned long long)b options:(id)c ;
 - (void) _updateUserInfoValue:(id)a forKey:(id)b ;
 - (void) _removeUserInfoValueForKey:(id)a ;
 - (id) _frameworkPayload;
 - (void) _setFrameworkPayload:(id)a ;
 - (void) _updateFrameworkPayloadValue:(id)a forKey:(id)b ;
