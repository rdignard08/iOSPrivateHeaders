...
@interface NSXMLParser : NSObject {
    ...
    @"NSURL" _url;
    Q _externalEntityResolvingPolicy;
}
...
@property (atomic, assign, readwrite) NSNumber* shouldResolveExternalEntities;
 ...
 - (Q) externalEntityResolvingPolicy;
 - (id) allowedExternalEntityURLs;
 - (void) _setExpandedParserError:(id)a;
 - (void) _setParserError:(q)a;
 - (BOOL) shouldResolveExternalEntities;
 - (BOOL) parseData:(id)a;
 - (BOOL) _handleParseResult:(q)a;
 ...
 - (void) setExternalEntityResolvingPolicy:(Q)a;
