...
@property (nonatomic, assign, readwrite) NSNumber* angularVelocity;
 ...
 - (void) applyUnscaledImpulse:({CGVector=dd})a atPoint:({CGPoint=dd})b ;
 - (void) applyUnscaledForce:({CGVector=dd})a atPoint:({CGPoint=dd})b ;
 ...
 - (id) initWithCircleOfRadius:(double)a center:({CGPoint=dd})b ;
 - (id) initWithRectangleOfSize:({CGSize=dd})a center:({CGPoint=dd})b ;
 - (id) initWithEdgeFromPoint:({CGPoint=dd})a toPoint:({CGPoint=dd})b ;
 ...
 - (id) initWithRectangleOfSize:({CGSize=dd})a center:({CGPoint=dd})b edgeRadius:(float)c ;
 ...
 - (BOOL) _allowSleep;
 - (void) applyForce:({CGPoint=dd})a atPoint:({CGPoint=dd})b ;
 - (void) applyForce:({CGPoint=dd})a ;
 - (void) applyTorque:(double)a ;
 - (void) applyImpulse:({CGVector=dd})a atPoint:({CGPoint=dd})b ;
 - (void) applyAngularImpulse:(double)a ;
 - (BOOL) isResting;
 - (id) joints;
 - (double) area;
 - (void) reapplyScale:(double)a yScale:(double)b ;
