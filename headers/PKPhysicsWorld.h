...
@property (nonatomic, assign, readwrite) NSNumber* contactDelegate;
 ...
 - (BOOL) stepWithTime:(d)avelocityIterations:(Q)bpositionIterations:(Q)c;
 - (id) bodies;
 - (id) init;
 ...
 - (void) setVelocityThreshold:(d)a;
 - (d) velocityThreshold;
 - (BOOL) hasBodies;
 - (BOOL) hasFields;
 - (void) addField:(id)a;
 - (void) removeField:(id)a;
 - (id) sampleFields:({CGRect={CGPoint=dd}{CGSize=dd}})acategories:(I)bdataSize:({CGSize=dd})c;
 - ({CGVector=dd}) sampleFields:({CGPoint=dd})a;
 - ({CGVector=dd}) evalForce:(I)apoint:({CGPoint=dd})b;
 - ({b2Vec2=ff}) _gravity;
 - (BOOL) _doSleep;
 - (id) _bodies;
 - (void) debugDraw:(f)amatrix:((_GLKMatrix4={?=ffffffffffffffff}[16f]))bshowsPhysics:(BOOL)cshowsOutlineInterior:(BOOL)dshowsFields:(BOOL)e;
