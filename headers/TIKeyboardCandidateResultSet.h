...
@property (nonatomic, retain, readwrite) TIKeyboardCandidate* acceptedCandidate;
 ...
 - (id) initWithCandidates:(id)a initialSelectedIndex:(unsigned long long)b defaultCandidate:(id)c sortMethods:(id)d sortMethodGroups:(id)e indexTitles:(id)f showExtensionCandidates:(id)g initiallyHiddenCandidates:(id)h selectedHiddenCandidateIndex:(unsigned long long)i excludedExtensionCandidates:(BOOL)j ;
