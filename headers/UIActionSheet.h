...
@interface UIActionSheet : UIView <UIPopoverControllerDelegate> {
 ...
 - (void) _didPresent;
 - (void) _showFromRect:({CGRect={CGPoint=dd}{CGSize=dd}})ainView:(id)bdirection:(unsigned long long)canimated:(BOOL)d;
 ...
 - (void) presentFromBarButtonItem:(id)adirection:(unsigned long long)ballowInteractionWithViews:(id)cbackgroundStyle:(long long)danimated:(BOOL)e;
 - (void) presentFromRect:({CGRect={CGPoint=dd}{CGSize=dd}})ainView:(id)bdirection:(unsigned long long)callowInteractionWithViews:(id)dbackgroundStyle:(long long)eanimated:(BOOL)f;
