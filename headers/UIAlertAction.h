...
@property (nonatomic, copy, readwrite, setter=_setDescriptiveText:) NSString* _descriptiveText;
@property (nonatomic, retain, readwrite, getter=_contentViewController, setter=_setContentViewController:) UIViewController* contentViewController;
@property (atomic, assign, readwrite, setter=_setRepresenter:) NSNumber* _representer;
@property (atomic, assign, readwrite, setter=_setIsDefault:) NSNumber* _isDefault;
@property (nonatomic, assign, readwrite, setter=_setAlertController:) UIAlertController* _alertController;
