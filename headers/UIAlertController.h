...
@interface UIAlertController : UIViewController <UIAlertControllerContaining, _UIAlertControllerTextFieldViewControllerContaining, UIAlertControllerVisualStyleProviding> {
 ...
 + (id) alertControllerWithTitle:(id)amessage:(id)bpreferredStyle:(q)c;
 ...
 - (d) _contentVerticalInsets;
 - (id) _visualStyle;
 - (BOOL) _canDismissWithGestureRecognizer;
 - (id) _dismissGestureRecognizer;
 - (id) _containedAlertController;
 - (void) setPreferredStyle:(q)a;
 - (void) _addActionWithTitle:(id)astyle:(q)bhandler:(@?)cshouldDismissHandler:(@?)d;
 - (void) addAction:(id)a;
 ...
 - (id) _styleProvider;
 - (id) visualStyleForAlertControllerStyle:(q)atraitCollection:(id)bdescriptor:(id)c;
 - (id) _cancelAction;
 - (BOOL) _idiomSupportsBackGesture:(q)a;
 - (void) _dismissFromBackButton:(id)a;
 - (q) _buttonTypeForBackGestureForIdiom:(q)a;
 ...
 - (q) _modalPresentationStyleForResolvedStyle;
 ...
 - (void) _addActionWithTitle:(id)astyle:(q)bhandler:(@?)c;
 - (void) _addActionWithTitle:(id)aimage:(id)bstyle:(q)chandler:(@?)d;
