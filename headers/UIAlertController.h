...
@interface UIAlertController : UIViewController <UIAlertControllerContaining, _UIAlertControllerTextFieldViewControllerContaining, UIAlertControllerVisualStyleProviding> {
 ...
 - (void) _addActionWithTitle:(id)a style:(long long)b handler:(@?)c shouldDismissHandler:(@?)d ;
 - (void) addAction:(id)a ;
 ...
 - (void) _dismissAnimated:(BOOL)a triggeringAction:(id)b ;
 ...
 - (id) _styleProvider;
 - (id) visualStyleForAlertControllerStyle:(long long)a traitCollection:(id)b descriptor:(id)c ;
 - (id) _cancelAction;
 ...
 - (id) cancelAction;
 - (void) _dismissAnimated:(BOOL)a triggeringAction:(id)b triggeredByPopoverDimmingView:(BOOL)c ;
 ...
 - (void) _addActionWithTitle:(id)a style:(long long)b handler:(@?)c ;
 - (void) _addActionWithTitle:(id)a image:(id)b style:(long long)c handler:(@?)d ;
