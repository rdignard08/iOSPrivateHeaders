...
@interface UICalloutBar : UIView {
    ...
    d m_supressedHorizontalMovementX;
    i m_arrowDirection;
 ...
 - (void) configureButtons:(d)a;
 - (void) updateForCurrentPage;
 - (void) setArrowDirection:(i)a;
 ...
 - (void) setTargetRect:({CGRect={CGPoint=dd}{CGSize=dd}})aarrowDirection:(i)b;
