...
@property (nonatomic, assign, readwrite) NSNumber* resetRasterizationAfterAnimation;
 ...
 - (id) initWithView:(id)a viewType:(int)b finalLayoutAttributes:(id)c startFraction:(double)d endFraction:(double)e animateFromCurrentPostion:(BOOL)f deleteAfterAnimation:(BOOL)g customAnimations:(@?)h ;
