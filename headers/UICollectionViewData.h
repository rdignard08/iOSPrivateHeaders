...
@property (nonatomic, assign, readonly) NSArray* clonedDecorationAttributes;
 ...
 - (id) initWithCollectionView:(id)a layout:(id)b ;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) rectForDecorationElementOfKind:(id)a atIndexPath:(id)b ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) rectForSupplementaryElementOfKind:(id)a atIndexPath:(id)b ;
 - (id) knownDecorationElementKinds;
 - (void) invalidateSupplementaryIndexPaths:(id)a ;
 - (void) invalidateDecorationIndexPaths:(id)a ;
 - (void) shimMoveForItemAtIndexPath:(id)a toIndexPath:(id)b ;
 - (void) _updateItemCounts;
 - (void) _validateItemCounts;
 - (void) _validateContentSize;
 - (id) _screenPageForPoint:({CGPoint=dd})a ;
 - (void) _setupMutableIndexPath:(^@)a forGlobalItemIndex:(int)b ;
 - (void) _setLayoutAttributes:(id)a atGlobalItemIndex:(int)b ;
