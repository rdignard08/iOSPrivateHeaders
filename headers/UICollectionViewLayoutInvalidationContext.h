...
@property (nonatomic, assign, readwrite, getter=_updateItems, setter=_setUpdateItems:) NSArray* updateItems;
 ...
 - (void) _invalidateSupplementaryElementsOfKind:(id)a atIndexPaths:(id)b ;
 - (void) _setInvalidatedSupplementaryViews:(id)a ;
 - (void) invalidateSupplementaryElementsOfKind:(id)a atIndexPaths:(id)b ;
 - (void) invalidateDecorationElementsOfKind:(id)a atIndexPaths:(id)b ;
