...
@property (nonatomic, retain, readwrite, getter=_systemColorName, setter=_setSystemColorName:) NSString* systemColorName;
 ...
 - (BOOL) _getWhite:(^d)a alpha:(^d)b ;
 - (id) _systemColorName;
 - (id) initWithWhite:(double)a alpha:(double)b ;
 - (^{CGColor=}) cgColor;
 - (BOOL) _getRed:(^d)a green:(^d)b blue:(^d)c alpha:(^d)d ;
 ...
 - (double) _luminance;
 - (id) _colorBlendedWithColor:(id)a compositingFilter:(id)b ;
 - (BOOL) _isSimilarToColor:(id)a withinPercentage:(double)b ;
