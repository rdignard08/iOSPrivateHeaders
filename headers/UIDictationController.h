...
@property (nonatomic, retain, readwrite) UIKeyboardInputMode* inputModeThatInvokedDictation;
 ...
 - (void) stopDictation;
 - (void) startDictation;
 - (BOOL) supportsInputMode:(id)a error:(^@)b ;
 - (void) startDictationForFileAtURL:(id)a forInputModeIdentifier:(id)b ;
 - (void) startConnectionForFileAtURL:(id)a forInputModeIdentifier:(id)b ;
 ...
 - (BOOL) _shouldInsertText:(id)a inInputDelegate:(id)b ;
 ...
 - (void) completeStartConnectionForFileAtURL:(id)a forInputModeIdentifier:(id)b ;
 ...
 - (void) endSessionIfNecessaryForTransitionFromState:(int)a toState:(int)b ;
 ...
 - (id) lastHypothesis;
 - (id) targetHypothesis;
 - (id) _hypothesisRangeFromSelectionRange:(id)a inputDelegate:(id)b ;
 - (id) _rangeByExtendingRange:(id)a backward:(long long)b forward:(long long)c inputDelegate:(id)d ;
 - (void) _updateFromSelectedTextRange:(id)a withNewHypothesis:(id)b ;
 - (void) insertSerializedDictationResult:(id)a withCorrectionIdentifier:(id)b ;
 ...
 - (void) finishDictationRecognitionWithPhrases:(id)a languageModel:(id)b correctionIdentifier:(id)c ;
 - (void) _displayLinkFired:(id)a ;
 - (id) pendingEdits;
 - (id) _getBestHypothesisRangeGivenHintRange:(id)a inputDelegate:(id)b hypothesisRange:(^{_NSRange=QQ})c documentTextInRange:(^@)d ;
 ...
 - (void) dictationConnection:(id)a didRecognizePhrases:(id)b languageModel:(id)c correctionIdentifier:(id)d ;
 - (void) dictationConnection:(id)a didHypothesizePhrases:(id)b languageModel:(id)c ;
 - (void) dictationConnection:(id)a didRecognizeTokens:(id)b languageModel:(id)c ;
 ...
 - (void) dictationConnection:(id)a speechRecordingDidFail:(id)b ;
 - (void) dictationConnection:(id)a speechRecognitionDidFail:(id)b ;
