...
@property (atomic, copy, readonly) NSURL* primaryPresentedItemURL;
 ...
 - (id) savingFileType;
 - (id) fileNameExtensionForType:(id)asaveOperation:(q)b;
 - (id) contentsForType:(id)aerror:(^@)b;
 - (id) changeCountTokenForSaveOperation:(q)a;
 - (id) fileAttributesToWriteToURL:(id)aforSaveOperation:(q)berror:(^@)c;
 - (BOOL) writeContents:(id)aandAttributes:(id)bsafelyToURL:(id)cforSaveOperation:(q)derror:(^@)e;
 - (void) _finishSavingToURL:(id)aforSaveOperation:(q)bchangeCount:(id)c;
 - (BOOL) _coordinateWritingItemAtURL:(id)aerror:(^@)bbyAccessor:(@?)c;
 - (void) updateChangeCountWithToken:(id)aforSaveOperation:(q)b;
 - (BOOL) hasUnsavedChanges;
 - (void) _scheduleAutosaving;
 - (void) _autosaveWithCompletionHandler:(@?)a;
 - (d) _autosavingDelay;
 - (void) _scheduleAutosavingAfterDelay:(d)areset:(BOOL)b;
 - (void) _rescheduleAutosaving;
 - (void) _autosavingCompletedSuccessfully:(BOOL)a;
 - (void) saveToURL:(id)aforSaveOperation:(q)bcompletionHandler:(@?)c;
 ...
 - (id) _presentableFileNameForSaveOperation:(q)aurl:(id)b;
