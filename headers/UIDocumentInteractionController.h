...
@property (nonatomic, assign, readonly) _UIPreviewItemProxy* previewItemProxy;
 ...
 - (void) openResourceOperation:(id)adidFinishCopyingResource:(id)b;
 - (void) dealloc;
 - (id) name;
 - (id) initWithURL:(id)a;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) previewController:(id)aframeForPreviewItem:(id)binSourceView:(^@)c;
 ...
 - (BOOL) _isFilenameValidForUnzipping:(id)aallowsArchiveZip:(BOOL)b;
 - (BOOL) _isVideo;
 - (BOOL) _isImage;
 ...
 - (BOOL) presentOptionsMenuFromRect:({CGRect={CGPoint=dd}{CGSize=dd}})ainView:(id)banimated:(BOOL)c;
 - (BOOL) presentOpenInMenuFromRect:({CGRect={CGPoint=dd}{CGSize=dd}})ainView:(id)banimated:(BOOL)c;
 - (id) annotation;
 ...
 - (id) _unzipFileAndSetupPayload:(id)acompletion:(@?)b;
 - (void) dismissMenuAnimated:(BOOL)a;
 - (void) setUTI:(id)a;
 - (BOOL) shouldUnzipDocument;
 - (BOOL) presentOptionsMenuFromBarButtonItem:(id)aanimated:(BOOL)b;
 - (id) presentingNavigationController;
 - (BOOL) presentOpenInMenuFromBarButtonItem:(id)aanimated:(BOOL)b;
 ...
 - (id) extractSubitemFromArchive:(id)acompletion:(@?)b;
 - (id) URL;
 - (id) delegate;
 - (void) setURL:(id)a;
