...
@interface UIFieldEditor : UIScrollView <UITextInputControllerDelegate, NSLayoutManagerDelegate, NSUITextViewCommonMethods, UIAutoscrollContainer, UITextInput, UITextAutoscrolling, UIKeyboardInput> {
 ...
 - (i) scrollYOffset;
 - (void) setScrollXOffset:(i)ascrollYOffset:(i)badjustForPurpleCaret:(BOOL)c;
 - (id) textInputView;
 ...
 - (q) layoutManager:(id)ashouldUseAction:(q)bforControlCharacterAtIndex:(Q)c;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) layoutManager:(id)aboundingBoxForControlGlyphAtIndex:(Q)bforTextContainer:(id)cproposedLineFragment:({CGRect={CGPoint=dd}{CGSize=dd}})dglyphPosition:({CGPoint=dd})echaracterIndex:(Q)f;
 - (Q) layoutManager:(id)ashouldGenerateGlyphs:(r^S)bproperties:(r^q)ccharacterIndexes:(r^Q)dfont:(id)eforGlyphRange:({_NSRange=QQ})f;
