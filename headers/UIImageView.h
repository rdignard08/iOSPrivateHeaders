...
@interface UIImageView : UIView {
 ...
 - (void) setImageWithURL:(id)a placeholderImage:(id)b ;
 - (void) setImageWithURLRequest:(id)a placeholderImage:(id)b success:(@?)c failure:(@?)d ;
 ...
 - (BOOL) _needsImageEffectsForImage:(id)a suppressColorizing:(BOOL)b ;
 - (void) _drawImageEffectsForImage:(id)a inRect:({CGRect={CGPoint=dd}{CGSize=dd}})b ;
 - (BOOL) isAnimating;
 - (BOOL) _setImageViewContents:(id)a ;
 - (void) _setDecompressingImage:(id)a forType:(unsigned long long)b ;
 - (void) stopAnimating;
 - (void) _clearPretiledImageCacheForImage:(id)a ;
 - (void) _updateImageViewForOldImage:(id)a newImage:(id)b ;
 - (void) _updatePretiledImageCacheForImage:(id)a ;
 - (void) _updateState;
 - (void) _updateTemplateProperties;
 - (BOOL) _recomputePretilingState;
 - (void) _setViewGeometry:({CGRect={CGPoint=dd}{CGSize=dd}})a forMetric:(int)b ;
 ...
 - (id) _adaptiveImageForImage:(id)a assignedImage:(id)b currentImage:(id)c hasAdapted:(^B)d ;
 - (id) initWithImage:(id)a highlightedImage:(id)b ;
 ...
 - (id) _checkImageForAdaptation:(id)a hasAdapted:(^B)b ;
 - (id) _checkHighlightedImageForAdaptation:(id)a hadAdapted:(^B)b ;
 - (BOOL) _templateSettingsAreInvalid;
 - (BOOL) _edgeInsetsForEffectsAreValid;
