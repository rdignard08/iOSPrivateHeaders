...
@property (nonatomic, assign, readonly) UIView* layeringView;
 ...
 - (BOOL) setAccessoryViewVisible:(BOOL)a delay:(double)b ;
 ...
 - (id) initWithInputView:(id)a accessoryView:(id)b isKeyboard:(BOOL)c ;
 ...
 - (BOOL) inSyncWithOrientation:(long long)a forKeyboard:(id)b ;
