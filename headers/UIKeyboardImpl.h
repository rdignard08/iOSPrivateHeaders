...
@interface UIKeyboardImpl : UIView <_UIIVCResponseDelegateImpl, UIKeyboardCandidateListDelegate> {
 ...
 - (BOOL) callShouldReplaceExtendedRange:(long long)awithText:(id)bincludeMarkedText:(BOOL)c;
 ...
 - (void) deleteFromInputWithFlags:(unsigned long long)aexecutionContext:(id)b;
 ...
 - (void) addInputString:(id)awithFlags:(unsigned long long)bexecutionContext:(id)c;
 ...
 - (void) addWordTerminator:(id)aafterSpace:(BOOL)belapsedTime:(double)cexecutionContext:(id)d;
 ...
 - (id) handleDoubleSpacePeriodForInputString:(id)aafterSpace:(BOOL)belapsedTime:(double)c;
 ...
 - (BOOL) callShouldDeleteWithWordCountForRapidDelete:(int)acharacterCountForRapidDelete:(int)b;
 ...
 - (void) acceptCandidate:(id)aatIndex:(unsigned long long)bexecutionContext:(id)c;
 ...
 - (BOOL) acceptWord:(id)afirstDelete:(unsigned long long)bforInput:(id)c;
 - (void) acceptCurrentCandidateForInput:(id)aexecutionContext:(id)b;
 - (void) acceptCandidate:(id)aatIndex:(unsigned long long)b;
 - (BOOL) geometryIsChanging;
 ...
 - (BOOL) acceptWord:(id)afirstDelete:(unsigned long long)b;
 ...
 - (void) _handleKeyBehavior:(unsigned long long)aforKeyType:(id)b;
 ...
 - (void) _handleWebKeyEvent:(id)awithEventType:(int)bwithInputString:(id)cwithInputStringIgnoringModifiers:(id)d;
 - (void) _handleWebKeyEvent:(id)awithIndex:(unsigned long long)binInputString:(id)cexecutionContext:(id)d;
 ...
 - (void) handleStringInput:(id)awithFlags:(unsigned long long)bexecutionContext:(id)c;
 - (BOOL) caretBlinks;
 ...
 - (void) timeMark:(unsigned int)amessage:(id)b;
 - (void) timeMark:(unsigned int)a;
 - (void) timeElapsed:(unsigned int)amessage:(id)b;
