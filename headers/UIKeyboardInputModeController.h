...
@property (nonatomic, retain, readwrite) NSNumber* extensionMatchingContext;
 ...
 - (id) nextInputModeFromList:(id)a withFilter:(unsigned long long)b withTraits:(id)c ;
 ...
 - (void) _setCurrentInputMode:(id)a force:(BOOL)b ;
 - (id) normalizedInputModes;
 - (id) suggestedInputModesForCurrentLocale:(BOOL)a fallbackToDefaultInputModes:(BOOL)b ;
 ...
 - (void) startDictationConnectionForFileAtURL:(id)a forInputModeIdentifier:(id)b ;
