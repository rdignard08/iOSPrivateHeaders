...
@interface UILabel : UIView <_UIMultilineTextContentSizing, NSCoding> {
 ...
 - (void) _invalidateAsNeededForNewSize:({CGSize=dd})a oldSize:({CGSize=dd})b ;
 - (void) _setText:(id)a ;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _textRectForBounds:({CGRect={CGPoint=dd}{CGSize=dd}})a limitedToNumberOfLines:(long long)b includingShadow:(BOOL)c ;
 - (BOOL) _shouldCeilSizeToViewScale;
 - (void) _baselineOffsetParametersDidChange;
 - (void) _setAttributedText:(id)a andTakeOwnership:(BOOL)b ;
 - (BOOL) _updateScaledMetricsForRect:({CGRect={CGPoint=dd}{CGSize=dd}})a ;
 - (id) highlightedTextColor;
 - (void) _setShadow:(id)a ;
 - (void) _drawTextInRect:({CGRect={CGPoint=dd}{CGSize=dd}})a baselineCalculationOnly:(BOOL)b ;
 - (double) _preferredMaxLayoutWidth;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) textRectForBounds:({CGRect={CGPoint=dd}{CGSize=dd}})a limitedToNumberOfLines:(long long)b ;
 - (id) letterpressStyle;
