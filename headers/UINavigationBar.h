...
@interface UINavigationBar : UIView <UIGestureRecognizerDelegate, _UIShadowedView, _UIBasicAnimationFactory, UIStatusBarTinting, _UIBarPositioningInternal, NSCoding, UIBarPositioning> {
 ...
 - (id) _timingFunctionForAnimationInView:(id)a withKeyPath:(id)b ;
 ...
 - (void) updatePrompt;
 - (void) _setLeftViews:(id)a rightViews:(id)b ;
 - (void) showBackButton:(BOOL)a animated:(BOOL)b ;
 ...
 - (void) setPrompt:(id)a ;
 - (id) _shadowView;
 - (void) setBackgroundImage:(id)a forBarMetrics:(long long)b ;
 - (void) _applySPIAppearanceToButtons;
 - (void) _setButtonItemTextColor:(id)a shadowColor:(id)b forState:(unsigned long long)c ;
 ...
 - (void) _setBackButtonBackgroundImage:(id)a mini:(id)b forStates:(unsigned long long)c ;
 - (void) _setButtonItemTextColor:(id)a shadowColor:(id)b ;
 - (void) _setPressedButtonItemTextColor:(id)a shadowColor:(id)b ;
 ...
 - (void) _palette:(id)a isAttaching:(BOOL)b didComplete:(BOOL)c ;
 ...
 - ({CGSize=dd}) defaultSizeForOrientation:(long long)a ;
 - (void) drawBackgroundInRect:({CGRect={CGPoint=dd}{CGSize=dd}})a withStyle:(long long)b ;
 - (void) _setDefaultBarMetrics:(long long)a ;
 - (void) _setActiveBarMetrics:(long long)a ;
 - (void) setTitleTextAttributes:(id)a ;
 - (void) setTitleVerticalPositionAdjustment:(double)a forBarMetrics:(long long)b ;
 ...
 - (void) _setupTopNavItem:(id)a oldTopNavItem:(id)b ;
 - (id) titleTextAttributes;
 - (void) _reenableUserInteraction;
 - (id) _defaultTitleFontWithScaleAdjustment:(double)a ;
 - (id) _defaultTitleFontFittingHeight:(double)a withScaleAdjustment:(double)b ;
 - (void) _fadeViewOut:(id)a ;
 - (void) _pushNavigationItem:(id)a transition:(int)b ;
 ...
 - (BOOL) _wantsLetterpressContent;
 - (id) _animationIds;
 - (void) _updateInteractiveStatusBarTransitionPercent:(double)a isFinished:(BOOL)b didComplete:(BOOL)c completionSpeed:(double)d completionCurve:(long long)e ;
 ...
 - (void) _startPushAnimationFromItems:(id)a fromBarStyle:(long long)b ;
 - (void) _startBarStyleAnimation:(long long)a withTintColor:(id)b ;
 ...
 - (id) navigationItems;
 - (void) _startPopAnimationFromItems:(id)a fromBarStyle:(long long)b toItems:(id)c toBarStyle:(long long)d ;
 - (void) setItems:(id)a animated:(BOOL)b ;
 - (id) items;
 - (int) _transitionForOldItems:(id)a newItems:(id)b ;
 - (void) _setItems:(id)a transition:(int)b ;
 - (BOOL) _didVisibleItemsChangeWithNewItems:(id)a oldItems:(id)b ;
 - (void) _removeItemsFromSuperview:(id)a ;
 - (void) _setItems:(id)a transition:(int)b reset:(BOOL)c ;
 - (void) setLocked:(BOOL)a ;
 - (void) _addItem:(id)a withEffectiveDelegate:(id)b transition:(int)c ;
 ...
 - (id) _commonHitTest:({CGPoint=dd})a forView:(id)b ;
 - (void) _setBackIndicatorPressed:(BOOL)a initialPress:(BOOL)b ;
 ...
 - (void) _updateNavigationBarItem:(id)a forStyle:(long long)b previousTintColor:(id)c ;
 - (void) _updateNavigationBarItem:(id)a forStyle:(long long)b ;
 - (void) _customViewChangedForButtonItem:(id)a ;
 - (id) _currentLeftViews;
 - (id) _currentRightViews;
 - (void) _updateNavigationBarItemsForStyle:(long long)a previousTintColor:(id)b ;
 ...
 - (void) showButtonsWithLeft:(id)a right:(id)b leftBack:(BOOL)c ;
 - (void) showLeftButton:(id)a withStyle:(int)b rightButton:(id)c withStyle:(int)d ;
 - (id) createButtonWithContents:(id)a width:(double)b barStyle:(long long)c buttonStyle:(int)d isRight:(BOOL)e ;
 - (void) _setLeftView:(id)a rightView:(id)b ;
 - (BOOL) _isIncomingButtonSameAsOutgoingButtonOnLeft:(BOOL)a ;
 - (void) _getTitleViewFrame:(^{CGRect={CGPoint=dd}{CGSize=dd}})a leftViewFrames:(id)b rightViewFrames:(id)c ;
 - (void) _incrementAnimationCountIfNecessary;
 - (void) _fadeViewsOut:(id)a ;
 - (void) _showLeftRightButtonsAnimationDidStop:(id)a finished:(id)b context:(id)c ;
 - (void) _hideButtonsAnimationDidStop:(id)a finished:(id)b context:(id)c ;
 - (id) currentLeftView;
 - (void) showHideBackButtomAnimationDidStop:(id)a finished:(id)b context:(id)c ;
 ...
 - (double) topItemAlpha;
 - (void) _getTitleViewFrame:(^{CGRect={CGPoint=dd}{CGSize=dd}})a leftViewFrames:(id)b rightViewFrames:(id)c forItemAtIndex:(unsigned long long)d ;
 - (void) _backgroundFadeDidFinish:(id)a finished:(id)b context:(id)c ;
 - (id) _effectiveBackIndicatorTransitionMaskImage;
 - (double) _backIndicatorClippingMargin;
 - (void) _wrapView:(id)a inClippingViewWithLeftBoundary:(double)b rightBoundary:(double)c leftMaskImage:(id)d leftMaskIsChevron:(BOOL)e rightMaskImage:(id)f ;
 - (double) _backTitleWidthOverTitleWidthForMatchingBackButtonView:(id)a titleView:(id)b withBackButtonWidth:(double)c ;
 - (void) _navigationAnimationDidFinish:(id)a finished:(id)b context:(id)c ;
 - (id) _allViews;
 - (double) defaultBackButtonAlignmentHeight;
 - (void) _getTitleViewFrame:(^{CGRect={CGPoint=dd}{CGSize=dd}})a leftViewFrames:(id)b rightViewFrames:(id)c forItemAtIndex:(unsigned long long)d returnedIdealWidthOfTextContent:(^d)e availableLayoutWidthForTextContent:(^d)f idealBackButtonWidth:(^d)g ;
 ...
 - (void) setAccessoryView:(id)a animate:(BOOL)b ;
 - (void) pushNavigationItem:(id)a animated:(BOOL)b ;
 - (void) _updateInteractiveTransition:(double)a ;
 - (void) _finishInteractiveTransition:(double)a completionSpeed:(double)b completionCurve:(long long)c ;
 - (void) _cancelInteractiveTransition:(double)a completionSpeed:(double)b completionCurve:(long long)c ;
 - (BOOL) _wantsAdaptiveBackdropForPalette;
 - (void) _popNestedNavigationItem;
 - (void) _pushNestedNavigationItem:(id)a ;
 - (void) _setItemsUpToItem:(id)a transition:(id)b ;
 - (void) _addItems:(id)a withEffectiveDelegate:(id)b transition:(int)c ;
 - (void) setNavigationItems:(id)a ;
 - (void) _cancelInProgressPushOrPop;
 - (void) _reenableUserInteractionWhenReadyWithContext:(id)a ;
 - (void) _evaluateBackIndicatorForHilightedState:(BOOL)a ofBarButtonItem:(id)b inNavigationItem:(id)c ;
 ...
 - (void) drawBackButtonBackgroundInRect:({CGRect={CGPoint=dd}{CGSize=dd}})a withStyle:(long long)b pressed:(BOOL)c ;
 - (void) showButtonsWithLeftTitle:(id)a rightTitle:(id)b ;
 - (void) showButtonsWithLeftTitle:(id)a rightTitle:(id)b leftBack:(BOOL)c ;
 - (void) setButton:(int)a enabled:(BOOL)b ;
 - (void) hideButtons;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) availableTitleArea;
 - (void) setTopItemAlpha:(double)a ;
 - (void) _removeAccessoryView;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _boundsForPrompt:(id)a inRect:({CGRect={CGPoint=dd}{CGSize=dd}})b withFont:(id)c barStyle:(long long)d ;
 - (void) _animateOldBackButtonView:(id)a toNewBackButtonView:(id)b duration:(double)c initialFrameForIncomingView:(@?)d destinationFrameForOutgoingView:(@?)e animationCleanup:(@?)f ;
