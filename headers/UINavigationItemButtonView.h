...
@interface UINavigationItemButtonView : UINavigationItemView <UIGestureRecognizerDelegate> {
 ...
 - (id) _backButtonBackgroundImageForState:(unsigned long long)a barMetrics:(long long)b ;
 ...
 - (void) setPressed:(BOOL)a initialPress:(BOOL)b ;
 - (BOOL) pressed;
 ...
 - (void) setStyle:(long long)a animated:(BOOL)b ;
 ...
 - (void) _styleAnimationDidStop:(id)a finished:(id)b context:(id)c ;
