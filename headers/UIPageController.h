...
@interface UIPageController : UIViewController {
 ...
 - (long long) pageCount;
 - (void) _scrollView:(id)a boundsDidChangeToSize:({CGSize=dd})b ;
 - (void) _scrollViewDidScroll:(id)a forceUpdate:(BOOL)b ;
 ...
 - (BOOL) _isViewControllerBeingUnloaded:(id)a atIndex:(long long)b ;
 - (void) _adjustScrollViewContentInsets;
 - (void) _replaceViewControllerAtIndex:(long long)a withViewController:(id)b ;
 - (id) _visibleViewController;
 - (void) _setPreviousViewController:(id)a ;
 - (void) _setVisibleViewController:(id)a ;
 - (void) _notifyVisibleViewController:(int)a animated:(BOOL)b ;
 ...
 - (void) _notifyViewController:(id)a ofState:(int)b previousState:(int)c animated:(BOOL)d ;
 ...
 - (void) _notifyPreviousViewController:(int)a animated:(BOOL)b ;
 - (void) _notifyNextViewController:(int)a animated:(BOOL)b ;
 ...
 - (void) setVisibleIndex:(long long)a preservingLoadedViewControllers:(BOOL)b animated:(BOOL)c ;
 - (void) setVisibleIndex:(long long)a ;
 - (void) reloadViewControllerAtIndex:(long long)a ;
 - (BOOL) _needToLoadPrevious;
 - (BOOL) _needToLoadNext;
 - (void) setVisibleIndex:(long long)a animated:(BOOL)b ;
