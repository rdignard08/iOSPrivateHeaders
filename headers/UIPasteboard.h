...
@property (nonatomic, copy, readwrite) NSArray* items;
 ...
 - (BOOL) containsPasteboardTypes:(id)ainItemSet:(id)b;
 - (void) setImages:(id)a;
 - (id) _initWithName:(id)asystem:(BOOL)bcreate:(BOOL)c;
 - (void) setData:(id)aforPasteboardType:(id)b;
 - (id) pasteboardTypesForItemSet:(id)a;
 - (void) _pasteboardChanged:(id)a;
 - (void) _addItems:(id)aoldPasteboardTypes:(id)b;
 - (id) pasteboardTypes;
 - (BOOL) containsPasteboardTypes:(id)a;
 - (id) dataForPasteboardType:(id)a;
 - (void) setValue:(id)aforPasteboardType:(id)b;
