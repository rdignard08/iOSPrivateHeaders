...
@property (nonatomic, assign, readonly) NSNumber* showPrinterWarning;
 ...
 - (void) dismissPrintPanel:(BOOL)a animated:(BOOL)b ;
 - (BOOL) showPageRange;
 ...
 - (id) paperList;
 - (BOOL) showPaper;
 - (id) initWithPrintInterationController:(id)a inParentController:(id)b ;
 - (void) presentPrintPanelAnimated:(BOOL)a ;
 - (void) presentPrintPanelFromRect:({CGRect={CGPoint=dd}{CGSize=dd}})a inView:(id)b animated:(BOOL)c ;
 - (void) presentPrintPanelFromBarButtonItem:(id)a animated:(BOOL)b ;
 - (void) startPrinting;
 - (BOOL) showDuplex;
 - (BOOL) showCopies;
