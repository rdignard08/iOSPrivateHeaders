...
@interface UIProgressView : UIView <NSCoding> {
 ...
 - (void) setProgressWithUploadProgressOfTask:(id)a animated:(BOOL)b ;
 - (void) setProgressWithDownloadProgressOfTask:(id)a animated:(BOOL)b ;
 - (void) setProgressWithUploadProgressOfOperation:(id)a animated:(BOOL)b ;
 - (void) setProgressWithDownloadProgressOfOperation:(id)a animated:(BOOL)b ;
 ...
 - (void) _setProgressAnimated:(float)a duration:(double)b delay:(double)c options:(unsigned long long)d ;
 - (void) setProgressTintColor:(id)a ;
 - (id) initWithProgressViewStyle:(long long)a ;
 - (void) setProgress:(float)a animated:(BOOL)b ;
 - (id) _progressColor;
