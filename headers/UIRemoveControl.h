...
@interface UIRemoveControl : UIView {
 ...
 - (void) _doInsert:(id)a ;
 - (void) _doRemove:(id)a ;
 - (void) addConfirmationButtonSubview:(id)a withWidth:(float)b target:(id)c ;
 ...
 - (void) setRemoveConfirmationVisible:(BOOL)a animated:(BOOL)b ;
 - (void) _setRemoveConfirmationShowing:(BOOL)a animated:(BOOL)b ;
 ...
 - (void) showRemoveButton:(BOOL)a animated:(BOOL)b ;
