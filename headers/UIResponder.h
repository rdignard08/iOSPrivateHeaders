...
@property (nonatomic, assign, readonly) NSUndoManager* undoManager;
 ...
 - (id) targetForAction:(SEL)a withSender:(id)b ;
 ...
 - (id) _window;
 - (void) _completeForwardingTouches:(id)a phase:(long long)b event:(id)c ;
 ...
 - (id) _userActivity;
 - (id) _editingDelegate;
 - (BOOL) _canChangeFirstResponder:(id)a toResponder:(id)b ;
 - (void) _finishResignFirstResponder;
 - (void) _becomeFirstResponder;
 - (void) reloadInputViews;
 - (void) _resignFirstResponder;
 - (BOOL) canResignFirstResponder;
 - (id) _targetForAction:(SEL)a withSender:(id)b canPerformActionBlock:(@?)c ;
 ...
 - (void) _completeForwardingTouches:(id)a phase:(long long)b event:(id)c index:(unsigned long long)d ;
