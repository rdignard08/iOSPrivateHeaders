...
@interface UISearchBar : UIView <UITextInputTraits_Private, UIStatusBarTinting, _UIBarPositioningInternal, UIBarPositioning, UITextInputTraits> {
 ...
 - (BOOL) textField:(id)a shouldChangeCharactersInRange:({_NSRange=QQ})b replacementString:(id)c ;
 ...
 - (id) _imageForSearchBarIcon:(long long)a state:(unsigned long long)b ;
 - (void) _resultsListButtonPressed;
 - (void) _bookmarkButtonPressed;
 - (void) setShowsCancelButton:(BOOL)a animated:(BOOL)b ;
 - (void) _allowCursorToAppear:(BOOL)a ;
 - (void) _destroyCancelButton;
 - (BOOL) _isInBar;
 - (void) _displayNavBarCancelButton:(BOOL)a animated:(BOOL)b ;
 ...
 - (void) _setBarTintColor:(id)a forceUpdate:(BOOL)b ;
 ...
 - (id) controller;
 - (void) _setUpScopeBar;
 - (void) _setShowsScopeBar:(BOOL)a animateOpacity:(BOOL)b ;
 - (void) _effectiveBarTintColorDidChange:(BOOL)a ;
 - (void) _updateNeedForBackdrop;
 - (id) _glyphAndTextColor:(BOOL)a ;
 - (id) _imageForSearchBarIcon:(long long)a state:(unsigned long long)b customImage:(^B)c ;
 - (BOOL) _isAtTop;
 ...
 - (void) setImage:(id)a forSearchBarIcon:(long long)b state:(unsigned long long)c ;
 - (id) imageForSearchBarIcon:(long long)a state:(unsigned long long)b ;
 - (void) setScopeBarButtonBackgroundImage:(id)a forState:(unsigned long long)b ;
 - (id) scopeBarButtonBackgroundImageForState:(unsigned long long)a ;
 - (void) setScopeBarButtonDividerImage:(id)a forLeftSegmentState:(unsigned long long)b rightSegmentState:(unsigned long long)c ;
 - (id) scopeBarButtonDividerImageForLeftSegmentState:(unsigned long long)a rightSegmentState:(unsigned long long)b ;
 - (void) setScopeBarButtonTitleTextAttributes:(id)a forState:(unsigned long long)b ;
 - (id) scopeBarButtonTitleTextAttributesForState:(unsigned long long)a ;
 - (void) setPositionAdjustment:({UIOffset=dd})a forSearchBarIcon:(long long)b ;
