...
@interface UISearchBar : UIView <UITextInputTraits_Private, UIStatusBarTinting, _UIBarPositioningInternal, UIBarPositioning, UITextInputTraits> {
 ...
 - (id) _imageForSearchBarIcon:(q)astate:(Q)b;
 ...
 - (id) _imageForSearchBarIcon:(q)astate:(Q)bcustomImage:(^B)c;
 - (BOOL) _isAtTop;
 ...
 - (void) setSelectedScopeButtonIndex:(q)a;
 - (q) selectedScopeButtonIndex;
 ...
 - (void) setImage:(id)aforSearchBarIcon:(q)bstate:(Q)c;
 - (id) imageForSearchBarIcon:(q)astate:(Q)b;
 - (void) setScopeBarButtonBackgroundImage:(id)aforState:(Q)b;
 - (id) scopeBarButtonBackgroundImageForState:(Q)a;
 - (void) setScopeBarButtonDividerImage:(id)aforLeftSegmentState:(Q)brightSegmentState:(Q)c;
 - (id) scopeBarButtonDividerImageForLeftSegmentState:(Q)arightSegmentState:(Q)b;
 - (void) setScopeBarButtonTitleTextAttributes:(id)aforState:(Q)b;
 - (id) scopeBarButtonTitleTextAttributesForState:(Q)a;
 - (void) setPositionAdjustment:({UIOffset=dd})aforSearchBarIcon:(q)b;
 - ({UIOffset=dd}) positionAdjustmentForSearchBarIcon:(q)a;
 - (id) _animatedAppearanceBarButtonItem;
 - (void) _setBackgroundLayoutNeedsUpdate:(BOOL)a;
 - (void) _setBackdropStyle:(Q)a;
 - (Q) _backdropStyle;
 - (void) setCenterPlaceholder:(BOOL)a;
 - (q) searchFieldLeftViewMode;
 - (void) setSearchFieldLeftViewMode:(q)a;
 - (id) _alternateTitle;
 ...
 - (void) _updateBackgroundToBackdropStyle:(q)a;
