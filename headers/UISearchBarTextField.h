...
@interface UISearchBarTextField : UITextField {
 ...
 - (void) _setClearButtonImage:(id)a forState:(unsigned long long)b ;
 - (void) _setSearchTextOffetValue:(id)a ;
 - (id) _searchTextOffsetValue;
 - (void) _setOffsetValue:(id)a forIcon:(long long)b ;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _adjustedTextOrEditingRect:({CGRect={CGPoint=dd}{CGSize=dd}})a forBounds:({CGRect={CGPoint=dd}{CGSize=dd}})b ;
 ...
 - (void) _updateBackgroundView:(id)a withStyle:(unsigned long long)b filter:(id)c ;
 - (id) _createEffectsBackgroundViewWithStyle:(unsigned long long)a applyFilter:(id)b ;
