...
@interface UISearchDisplayController : NSObject <_UIScrollNotification> {
    ...
    d _lastKeyboardAdjustment;
    d _lastFooterAdjustment;
    @"UIPopoverController" _popoverController;
    q _searchResultsTableViewStyle;
    ...
    d _animatingAppearanceNavigationSearchBarWidth;
    @"UIColor" _dimmingOverlayColor;
    @"UIView" _tableViewBackgroundHeaderView;
    q _unactivatedBarPosition;
    ...
    Q _navigationBarSearchFieldSizing;
    d __activationGapHeight;
    d __additionalNonCollapsingHeightAboveSearchBar;
}
...
@property (nonatomic, assign, readwrite) NSNumber* _additionalNonCollapsingHeightAboveSearchBar;
 ...
 - (Q) navigationBarSearchFieldSizing;
 - (void) searchBar:(id)aselectedScopeButtonIndexDidChange:(q)b;
 ...
 - (id) initWithSearchBar:(id)acontentsController:(id)bsearchResultsTableViewStyle:(q)c;
 ...
 - (d) _additionalNonCollapsingHeightAboveSearchBar;
 ...
 - (d) _dimmingViewAlpha;
 - (void) set_additionalNonCollapsingHeightAboveSearchBar:(d)a;
 - (void) showHideAnimationDidFinish;
 - (void) _updatePinnedSearchBar;
 - (d) _updateNavigationPalette;
 ...
 - (void) setNavigationBarSearchFieldSizing:(Q)a;
 ...
 - (d) _activationGapHeight;
 - (void) set_activationGapHeight:(d)a;
 - (id) init;
