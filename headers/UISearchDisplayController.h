...
@property (nonatomic, assign, readwrite, getter=isActive) NSNumber* active;
...
@property (nonatomic, assign, readwrite, getter=isNavigationBarHidingEnabled) NSNumber* navigationBarHidingEnabled;
@property (nonatomic, assign, readwrite) NSNumber* dimTableViewOnEmptySearchString;
@property (nonatomic, assign, readwrite, getter=_isCancelButtonManagementDisabled, setter=_setCancelButtonManagementDisabled:) NSNumber* cancelButtonManagementDisabled;
...
@property (nonatomic, assign, readwrite) NSNumber* _additionalNonCollapsingHeightAboveSearchBar;
 ...
 - (void) searchBar:(id)a selectedScopeButtonIndexDidChange:(long long)b ;
 ...
 - (id) initWithSearchBar:(id)a contentsController:(id)b ;
 - (id) initWithSearchBar:(id)a contentsController:(id)b searchResultsTableViewStyle:(long long)c ;
 ...
 - (void) setActive:(BOOL)a animated:(BOOL)b ;
 ...
 - (void) _setTableViewVisible:(BOOL)a inView:(id)b ;
