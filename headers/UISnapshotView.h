...
@interface UISnapshotView : UIView <UIStatusBarTinting> {
 ...
 - (void) captureSnapshotOfView:(id)a withSnapshotType:(int)b ;
 - (void) _setStatusBarTintColor:(id)a ;
 - (void) setEdgePadding:({UIEdgeInsets=dddd})a ;
 - (void) setEdgePaddingColor:(id)a ;
 - (void) captureSnapshotRect:({CGRect={CGPoint=dd}{CGSize=dd}})a fromView:(id)b withSnapshotType:(int)c ;
 ...
 - (void) _drawEdges:({UIEdgeInsets=dddd})a withContentSize:({CGSize=dd})b ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _contentsCenterForEdgePadding:({UIEdgeInsets=dddd})a withContentSize:({CGSize=dd})b ;
