...
@interface UITabBarController : UIViewController <UIGestureRecognizerDelegate, UITabBarDelegate, NSCoding> {
 ...
 - (void) _hideBarWithTransition:(int)aisExplicit:(BOOL)b;
 ...
 - (void) _showBarWithTransition:(int)aisExplicit:(BOOL)b;
 ...
 - (void) transitionFromViewController:(id)atoViewController:(id)btransition:(int)cshouldSetSelected:(BOOL)d;
