...
@interface UITableView : UIScrollView <UIGestureRecognizerDelegatePrivate, UIScrollViewDelegate, NSCoding> {
 ...
 - (void) _reuseHeaderFooterView:(id)aisHeader:(BOOL)bforSection:(long long)c;
 ...
 - (id) _sectionHeaderViewWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})aforSection:(long long)bfloating:(BOOL)creuseViewIfPossible:(BOOL)dwillDisplay:(BOOL)e;
 - (BOOL) allowsFooterViewsToFloat;
 - (id) _sectionFooterViewWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})aforSection:(long long)bfloating:(BOOL)creuseViewIfPossible:(BOOL)dwillDisplay:(BOOL)e;
 ...
 - (id) _createPreparedCellForGlobalRow:(long long)awillDisplay:(BOOL)b;
 ...
 - (void) _setupSectionView:(id)aisHeader:(BOOL)bforSection:(long long)c;
 - (id) _cellReuseMapForType:(int)a;
 - (void) _reuseTableViewSubview:(id)aviewType:(int)b;
 ...
 - (void) _setupCell:(id)aforEditing:(BOOL)batIndexPath:(id)ccanEdit:(BOOL)deditingStyle:(long long)eshouldIndentWhileEditing:(BOOL)fshowsReorderControl:(BOOL)gaccessoryType:(long long)hanimated:(BOOL)iupdateSeparators:(BOOL)j;
 ...
 - (long long) _sectionIndexChangedToIndex:(long long)atitle:(id)b;
 ...
 - (void) scrollToRowAtIndexPath:(id)aatScrollPosition:(long long)banimated:(BOOL)c;
 ...
 - ({CGPoint=dd}) _contentOffsetForScrollingToRowAtIndexPath:(id)aatScrollPosition:(long long)b;
 ...
 - (void) _updateSections:(id)aupdateAction:(int)bwithRowAnimation:(long long)cheaderFooterOnly:(BOOL)d;
 - (void) _updateRowsAtIndexPaths:(id)aupdateAction:(int)bwithRowAnimation:(long long)c;
 ...
 - (BOOL) highlightRowAtIndexPath:(id)aanimated:(BOOL)bscrollPosition:(long long)c;
 ...
 - (void) _selectRowAtIndexPath:(id)aanimated:(BOOL)bscrollPosition:(long long)cnotifyDelegate:(BOOL)d;
 ...
 - (id) _dequeueReusableViewOfType:(int)awithIdentifier:(id)b;
 ...
 - (void) _updateTableHeaderViewForAutoHideWithVelocity:(double)atargetOffset:(^{CGPoint=dd})b;
 ...
 - (void) _registerThing:(id)aasNib:(BOOL)bforViewType:(int)cwithReuseIdentifer:(id)d;
 ...
 - (double) _heightForCell:(id)aatIndexPath:(id)b;
 ...
 - (void) _highlightCell:(id)aanimated:(BOOL)bscrollPosition:(long long)chighlight:(BOOL)d;
 ...
 - (void) _reorderPositionChangedForCell:(id)awithScrollFactorPercentage:(float)b;
 - (id) dequeueReusableHeaderFooterViewWithIdentifier:(id)a;
 - (id) _popReusableHeaderView:(BOOL)a;
 - (id) _newSectionViewWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})aforSection:(long long)bisHeader:(BOOL)c;
 - (id) _sectionHeaderView:(BOOL)awithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})bforSection:(long long)cfloating:(BOOL)dreuseViewIfPossible:(BOOL)ewillDisplay:(BOOL)f;
 - (long long) _accessoryTypeForCell:(id)aforRowAtIndexPath:(id)b;
 - (id) _createPreparedCellForGlobalRow:(long long)awithIndexPath:(id)bwillDisplay:(BOOL)c;
 - (id) _visibleHeaderViewForSection:(long long)aincludeTentativeViews:(BOOL)b;
 - (id) _visibleFooterViewForSection:(long long)aincludeTentativeViews:(BOOL)b;
 ...
 - (double) _heightForHeaderView:(id)ainSection:(long long)b;
 - (double) _heightForFooterView:(id)ainSection:(long long)b;
 ...
 - (void) scrollToNearestSelectedRowAtScrollPosition:(long long)aanimated:(BOOL)b;
 - (void) endUpdates;
 - (void) _performBatchUpdates:(@?)acompletion:(@?)b;
 - (void) insertSections:(id)awithRowAnimation:(long long)b;
 - (void) deleteSections:(id)awithRowAnimation:(long long)b;
 - (void) reloadSections:(id)awithRowAnimation:(long long)b;
 - (void) _reloadSectionHeaderFooters:(id)awithRowAnimation:(long long)b;
 - (void) moveSection:(long long)atoSection:(long long)b;
 - (void) insertRowsAtIndexPaths:(id)awithRowAnimation:(long long)b;
 - (void) deleteRowsAtIndexPaths:(id)awithRowAnimation:(long long)b;
 - (void) reloadRowsAtIndexPaths:(id)awithRowAnimation:(long long)b;
 ...
 - (double) _swipeToDeleteOffsetForRow:(long long)ainSection:(long long)b;
 ...
 - (double) _contentWidthForCell:(id)aforRowAtIndexPath:(id)b;
 ...
 - (void) _selectRowsAtIndexPaths:(id)aanimated:(BOOL)bscrollPosition:(long long)cnotifyDelegate:(BOOL)d;
 ...
 - (void) _setHeight:(double)aforRowAtIndexPath:(id)b;
