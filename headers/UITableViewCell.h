...
@interface UITableViewCell : UIView <UIScrollViewDelegate, NSCoding, UIGestureRecognizerDelegate> {
 ...
 - (void) _setAnimating:(BOOL)a clippingAdjacentCells:(BOOL)b ;
 ...
 - (void) setSelected:(BOOL)a animated:(BOOL)b ;
 ...
 - (void) _setTableBackgroundCGColor:(^{CGColor=})a withSystemColorName:(id)b ;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) removeControl:(id)a startFrameForTarget:(id)b ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) removeControl:(id)a endFrameForTarget:(id)b ;
 ...
 - (void) removeControl:(id)a wasCanceledForTarget:(id)b ;
 - (void) insertControl:(id)a shouldInsertWithTarget:(id)b ;
 - (void) removeControl:(id)a willRemoveTarget:(id)b ;
 - (id) _badge;
 - (void) cut:(id)a ;
 - (void) copy:(id)a ;
 - (void) paste:(id)a ;
 ...
 - (void) _grabberDragged:(id)a yDelta:(float)b ;
 ...
 - (void) _updateHighlightColorsForView:(id)a highlighted:(BOOL)b ;
 ...
 - (id) initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a reuseIdentifier:(id)b ;
 ...
 - (void) _drawContentInRect:({CGRect={CGPoint=dd}{CGSize=dd}})a selected:(BOOL)b ;
 - (void) _setupMenuGesture;
 - (void) _didCreateContentView;
 - (id) _textLabel;
 - (id) _detailTextLabel;
 - (id) _textLabel:(BOOL)a ;
 - (void) _setFont:(id)a layout:(BOOL)b ;
 - (void) _updateTopShadowView:(BOOL)a ;
 - (void) _setupSelectedBackgroundView;
 - (void) selectedBackgroundViewChange:(id)a finished:(id)b context:(id)c ;
 - (void) setSelectedBackgroundView:(id)a animated:(BOOL)b ;
 - (void) _resetSelectionTimer;
 - (void) _setSelectionStyle:(long long)a selectionTintColor:(id)b ;
 - (void) _deselectAnimationFinished;
 - (void) _updateHighlightColorsForAnimationHalfwayPoint;
 - (void) _cancelInternalPerformRequests;
 - (void) showSelectedBackgroundView:(BOOL)a animated:(BOOL)b ;
 ...
 - (void) _editingTransitionAnimationDidStop:(id)a finished:(id)b context:(id)c ;
 - (BOOL) wasSwiped;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) accessoryRectForBounds:({CGRect={CGPoint=dd}{CGSize=dd}})a accessoryView:(id)b isCustom:(BOOL)c ;
 ...
 - (void) _updateCellMaskViewsForView:(id)a backdropView:(id)b ;
 ...
 - (void) _setSectionLocation:(int)a animated:(BOOL)b forceBackgroundSetup:(BOOL)c ;
 ...
 - (BOOL) _isFocusable;
 - (void) _finishedFadingGrabber:(id)a finished:(BOOL)b ;
 ...
 - (void) _animateFloatingSeparatorForInsertion:(BOOL)a withRowAnimation:(long long)b ;
 - (void) _animateInnerShadowForInsertion:(BOOL)a withRowAnimation:(long long)b ;
