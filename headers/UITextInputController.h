...
@property (nonatomic, assign, readonly, getter=_caretRect) NSNumber* caretRect;
 ...
 - (id) textChecker;
 - (void) _addToTypingAttributes:(id)a value:(id)b ;
 ...
 - (void) _insertDictationResult:(id)a withCorrectionIdentifier:(id)b replacingRange:({_NSRange=QQ})c resultLength:(^Q)d ;
 - (void) _registerUndoOperationForReplacementWithActionName:(id)a replacementText:(id)b ;
 ...
 - (void) _sendDelegateChangeNotificationsForText:(BOOL)a selection:(BOOL)b ;
 - (void) _coordinateSelectionChange:(@?)a ;
 - (void) _invalidateTypingAttributes;
 - (void) _setSelectedRange:({_NSRange=QQ})a ;
 - (void) _sendDelegateWillChangeNotificationsForText:(BOOL)a selection:(BOOL)b ;
 - (id) _newAttributedStringForInsertionOfText:(id)a inRange:({_NSRange=QQ})b ;
 - ({_NSRange=QQ}) nsRangeForTextRange:(id)a ;
 - (void) registerUndoOperationForType:(int)a actionName:(id)b affectedRange:({_NSRange=QQ})c replacementText:(id)d ;
 - (void) _insertText:(id)a fromKeyboard:(BOOL)b ;
 - (void) checkSpellingForSelectionChangeIfNecessary;
 - (void) removeAlternativesForCurrentWord;
 - (void) _insertAttributedText:(id)a fromKeyboard:(BOOL)b ;
 ...
 - (unsigned long long) _validCaretPositionFromCharacterIndex:(unsigned long long)a downstream:(BOOL)b ;
 ...
 - (void) coalesceInTextView:(id)a affectedRange:({_NSRange=QQ})b replacementRange:({_NSRange=QQ})c ;
 - (id) textRangeForNSRange:({_NSRange=QQ})a ;
 - (id) _selectedText;
 - (void) removeTextStylingFromString:(id)a ;
 - (void) _copySelectionToClipboard;
 - (BOOL) _delegateShouldChangeTextInRange:({_NSRange=QQ})a replacementText:(id)b ;
