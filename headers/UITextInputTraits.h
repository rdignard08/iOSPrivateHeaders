...
@property (nonatomic, assign, readwrite) NSNumber* disablePrediction;
 ...
 + (long long) accessibleAppearanceForAppearance:(long long)a;
 + (BOOL) keyboardTypeRequiresASCIICapable:(long long)a;
 ...
 - (BOOL) displaySecureTextUsingPlainText;
 - (void) setAutocorrectionType:(long long)a;
 - (void) setSpellCheckingType:(long long)a;
 ...
 - (long long) updateResultComparedToTraits:(id)a;
 ...
 - (unsigned long long) insertionPointWidth;
 - (void) setInsertionPointWidth:(unsigned long long)a;
 - (int) textLoupeVisibility;
 - (void) setTextLoupeVisibility:(int)a;
 - (void) setTextSelectionBehavior:(int)a;
 - (id) textSuggestionDelegate;
 ...
 - (int) emptyContentReturnKeyType;
 - (void) setEmptyContentReturnKeyType:(int)a;
 - (BOOL) returnKeyGoesToNextResponder;
 ...
 - (void) setShortcutConversionType:(int)a;
 - (BOOL) suppressReturnKeyStyling;
 ...
 - (long long) autocapitalizationType;
 - (void) setAutocapitalizationType:(long long)a;
