...
@property (nonatomic, assign, readonly, getter=_domRange) DOMRange* domRange;
 ...
 - (id) selectionRects;
 - (void) alterSelection:({CGPoint=dd})a granularity:(long long)b ;
 ...
 - (void) smartExtendRangedSelection:(int)a downstream:(BOOL)b ;
 - (void) setRangedSelectionBaseToCurrentSelectionStart;
 - (void) setRangedSelectionInitialExtentToCurrentSelectionEnd;
 - (void) setRangedSelectionBaseToCurrentSelectionEnd;
 - (void) setRangedSelectionInitialExtentToCurrentSelectionStart;
 - (void) aggressivelyExpandSelectionToWordContainingCaretSelection;
 - (BOOL) setRangedSelectionExtentPoint:({CGPoint=dd})a baseIsStart:(BOOL)b allowFlipping:(BOOL)c ;
 - (BOOL) isCommitting;
 ...
 - (id) initialExtent;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) closestCaretRectForPoint:({CGPoint=dd})a inSelection:(BOOL)b ;
