...
@interface UITextView : UIScrollView <UITextLinkInteraction, UITextInputControllerDelegate, UITextAutoscrolling, UIKeyboardInput, UITextInputTraits_Private, _UIMultilineTextContentSizing, _UILayoutBaselineUpdating, UITextInput> {
 ...
 - (id) initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a font:(id)b ;
 - (void) _setDictationResult:(id)a withCorrectionIdentifier:(id)b ;
 ...
 - (void) _commonInitWithTextContainer:(id)a isDecoding:(BOOL)b isEditable:(BOOL)c isSelectable:(BOOL)d ;
 ...
 - (BOOL) usesTiledViews;
 - (void) _performLayoutCalculation:(@?)a inSize:({CGSize=dd})b ;
 ...
 - (void) _restoreScrollPosition:(id)a animated:(BOOL)b ;
 ...
 - (id) initReadonlyAndUnselectableWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a textContainer:(id)b ;
 ...
 - (void) _enableSiriAnimationDictationStyleWithCharacterInsertionRate:(double)a minimumDurationBetweenHypotheses:(double)b ;
