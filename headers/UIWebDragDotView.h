...
@interface UIWebDragDotView : UIView {
 ...
 - (BOOL) isPointedRight;
 - (BOOL) isPointedLeft;
 - (id) initWithEdge:({CGRect={CGPoint=dd}{CGSize=dd}})acontainer:(id)borientation:(i)c;
 - (void) setEdge:({CGRect={CGPoint=dd}{CGSize=dd}})a;
 - (void) setShowsBall:(BOOL)a;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) stickFrameForEdge:({CGRect={CGPoint=dd}{CGSize=dd}})awithOverlap:(d)b;
 - (BOOL) showsBall;
 - (BOOL) isVertical;
