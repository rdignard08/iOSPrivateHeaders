...
@property (nonatomic, retain, readwrite) NSNumber* extent;
 ...
 - (void) useBlock;
 - (d) distanceBetweenFirstRect:({CGRect={CGPoint=dd}{CGSize=dd}})asecond:({CGRect={CGPoint=dd}{CGSize=dd}})bedge:(i)c;
 - (id) duplicate;
 - (void) setDesiredSize:({CGSize=dd})a;
 - (BOOL) tryToShrinkToBaseAndExtent;
 - (BOOL) isEqualToSelection:(id)a;
 - (void) growFromEdge:(i)a;
 - (void) shrinkFromEdge:(i)a;
 - (id) domDocument;
 ...
 - (void) moveEdge:(i)aoutwards:(BOOL)b;
