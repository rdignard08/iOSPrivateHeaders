...
@interface UIWindow : UIView <NSISEngineDelegate> {
 ...
 - (void) _willTransitionToVirtualHorizontalSizeClass:(long long)a virtualVerticalSizeClass:(long long)b ;
 ...
 - (void) _setStateRestorationVerticalSizeClass:(long long)a horizontalSizeClass:(long long)b ;
 - (void) _setSystemGestureRecognitionIsPossible:(BOOL)a andTouchesAreCancelled:(BOOL)b ;
 ...
 - (id) _targetWindowForPathIndex:(long long)a atPoint:({CGPoint=dd})b forEvent:(id)c windowServerHitTestWindow:(id)d onScreen:(id)e ;
 ...
 - (void) _commonInitAttachedWindow:(BOOL)a debugName:(id)b scene:(id)c ;
 - (id) _initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a attached:(BOOL)b ;
 - (id) _initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a debugName:(id)b attached:(BOOL)c ;
 - (id) _initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a debugName:(id)b scene:(id)c attached:(BOOL)d ;
 - (int) bitsPerComponent;
 - (void) _updateContextOrderingAndSetLayerHidden:(BOOL)a ;
 - (void) setScreen:(id)a ;
 - (void) awakeFromNib;
 - (void) _setWindowInternalConstraints:(id)a ;
 - (void) _setMouseDownView:(id)a withEvent:(^{__GSEvent=})b ;
 ...
 - (@?) _deferredLaunchBlock;
 - (void) _updateToInterfaceOrientation:(long long)a duration:(double)b force:(BOOL)c ;
 - (void) _setHidden:(BOOL)a forced:(BOOL)b ;
 ...
 - (BOOL) _shouldAutorotateToInterfaceOrientation:(long long)a checkForDismissal:(BOOL)b isRotationDisabled:(^B)c ;
 - (BOOL) isRotating;
 - (long long) _deferredLaunchOrientation;
 - (void) _setDeferredLaunchBlock:(@?)a ;
 - (long long) _toWindowOrientation;
 - (void) _willChangeToSize:({CGSize=dd})a orientation:(long long)b screen:(id)c withTransitionCoordinator:(id)d ;
 ...
 - (void) _setRotatableViewOrientation:(long long)a duration:(double)b force:(BOOL)c ;
 ...
 - (void) setAutorotates:(BOOL)a forceUpdateInterfaceOrientation:(BOOL)b ;
 - (void) _handleStatusBarOrientationChange:(id)a ;
 - (void) _setRotatableViewOrientation:(long long)a updateStatusBar:(BOOL)b duration:(double)c force:(BOOL)d ;
 - (void) _updateStatusBarToInterfaceOrientation:(long long)a duration:(double)b fenceID:(int)c animation:(int)d ;
 - (void) _setRotatableClient:(id)a toOrientation:(long long)b updateStatusBar:(BOOL)c duration:(double)d force:(BOOL)e ;
 - (void) _setRotatableClient:(id)a toOrientation:(long long)b updateStatusBar:(BOOL)c duration:(double)d force:(BOOL)e isRotating:(BOOL)f ;
 - (void) _setRotatableClient:(id)a toOrientation:(long long)b applyTransformToWindow:(BOOL)c updateStatusBar:(BOOL)d duration:(double)e force:(BOOL)f isRotating:(BOOL)g ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _convertRectToSceneReferenceSpace:({CGRect={CGPoint=dd}{CGSize=dd}})a ;
 - (void) _setFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a sendTraitNotifications:(BOOL)b ;
 - (void) _rotateToBounds:({CGRect={CGPoint=dd}{CGSize=dd}})a withAnimator:(id)b transitionContext:(id)c ;
 - (void) _rotateWindowToOrientation:(long long)a updateStatusBar:(BOOL)b duration:(double)c skipCallbacks:(BOOL)d ;
 - (id) __clientsForRotationCallbacks;
 - (void) _finishedFirstHalfRotation:(id)a finished:(id)b context:(id)c ;
 - (void) _updateStatusBarToInterfaceOrientation:(long long)a duration:(double)b ;
 - (void) _finishedFullRotation:(id)a finished:(id)b context:(id)c ;
 - (void) _finishedFullRotation:(id)a finished:(id)b context:(id)c skipNotification:(BOOL)d ;
 - (BOOL) _alwaysGetsContexts;
 - (BOOL) _shouldPrepareScreenForWindow;
 - (void) _removeFocusEngine;
 - (void) _updateWindowTraitsAndNotify:(BOOL)a ;
 - (BOOL) _shouldPropigateTraitCollectionChanges;
 - (id) _traitCollectionForSize:({CGSize=dd})a screen:(id)b ;
 - (id) _traitCollectionForSize:({CGSize=dd})a screenCollection:(id)b ;
 ...
 - (void) _willTransitionToTraitCollection:(id)a withTransitionCoordinator:(id)b ;
 ...
 - (id) _debugName;
 - (id) _initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a debugName:(id)b ;
 ...
 - (void) orderOut:(id)a ;
 - (void) makeKey:(id)a ;
 - (id) _targetForStolenStatusBarTouchesAtPoint:({CGPoint=dd})a withEvent:(id)b excludingWindow:(id)c ;
 - (void) _scrollToTopViewsUnderScreenPointIfNecessary:({CGPoint=dd})a resultHandler:(@?)b ;
 - (BOOL) _disableAutomaticKeyboardBehavior;
 - (BOOL) _disableAutomaticKeyboardUI;
 - ({CGPoint=dd}) _convertOffset:({CGPoint=dd})a toWindow:(id)b ;
 - ({CGPoint=dd}) _convertOffset:({CGPoint=dd})a fromWindow:(id)b ;
 - ({CGPoint=dd}) _convertOffsetToSceneReferenceSpace:({CGPoint=dd})a ;
 - ({CGPoint=dd}) _convertOffsetFromSceneReferenceSpace:({CGPoint=dd})a ;
 - (double) _convertVisualAltitude:(double)a fromWindow:(id)b ;
 - (double) _convertVisualAltitude:(double)a toWindow:(id)b ;
 ...
 - (void) _slideFooterFromOrientation:(long long)a toOrientation:(long long)b startSnapshot:(id)c endSnapshot:(id)d duration:(double)e ;
 ...
 - (void) _updateToInterfaceOrientation:(long long)a animated:(BOOL)b ;
 - (void) _updateInterfaceOrientationFromDeviceOrientation;
 - (void) setAutorotates:(BOOL)a ;
 - (void) _setRotatableViewOrientation:(long long)a duration:(double)b ;
 - (void) _setRotatableViewOrientation:(long long)a updateStatusBar:(BOOL)b duration:(double)c ;
 - (void) _forceTwoPartRotationAnimation:(BOOL)a ;
 - (void) _setRotatableClient:(id)a toOrientation:(long long)b duration:(double)c force:(BOOL)d ;
 - (BOOL) autorotates;
 - (BOOL) isUsingOnePartRotationAnimation;
 - (void) _setWindowInterfaceOrientation:(long long)a ;
 - (void) synchronizeDrawingWithID:(int)a count:(unsigned long long)b ;
