...
@interface WAKScrollView : WAKView <WebCoreFrameScrollView> {
 ...
 - (id) documentView;
 - (void) setScrollingModes:(int)a vertical:(int)b andLock:(BOOL)c ;
 - (void) scrollingModes:(^i)a vertical:(^i)b ;
 ...
 - (void) setScrollBarsSuppressed:(BOOL)a repaintOnUnsuppress:(BOOL)b ;
 - ({CGPoint=dd}) scrollOrigin;
 - (void) scrollPoint:({CGPoint=dd})a ;
 - (void) setScrollOrigin:({CGPoint=dd})a updatePositionAtAll:(BOOL)b immediately:(BOOL)c ;
