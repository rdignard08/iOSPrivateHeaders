...
@interface WebAVPlayerController : NSObject <AVPlayerViewControllerDelegate> {
    ...
    d _minTime;
    d _maxTime;
    d _contentDurationWithinEndTimes;
...
@property (atomic, retain, readwrite) NSString* externalPlaybackAirPlayDeviceLocalizedName;
 ...
 - (q) externalPlaybackType;
 - (void) setRate:(d)a;
 - (id) seekableTimeRanges;
 - (BOOL) isExternalPlaybackActive;
 - (void) setPlayerControllerProxy:(id)a;
 - (void) setContentDuration:(d)a;
 - (void) setMaxTime:(d)a;
 - (void) setContentDurationWithinEndTimes:(d)a;
 ...
 - (BOOL) playerViewController:(id)ashouldExitFullScreenWithReason:(q)b;
 - (void) resetState;
 - (void) play:(id)a;
 - (void) pause:(id)a;
 ...
 - (d) minTime;
 - (d) maxTime;
 - (d) contentDurationWithinEndTimes;
 - (id) loadedTimeRanges;
 - (void) setExternalPlaybackActive:(BOOL)a;
 - (void) setExternalPlaybackType:(q)a;
