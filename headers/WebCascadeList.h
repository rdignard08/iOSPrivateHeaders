...
@interface WebCascadeList : NSArray {
 ...
 - (id) initWithFont:(r^{Font={FontDescription={RefCountedArray<WTF::AtomicString>=^{AtomicString}}{RefPtr<WebCore::FontFeatureSettings>=^{FontFeatureSettings}}ffb1b1b2b1b1b1b8b3b1b1b2b2b2b2b4b2b2b1b7}{RefPtr<WebCore::FontGlyphs>=^{FontGlyphs}}ffBb2})acharacter:(int)b;
