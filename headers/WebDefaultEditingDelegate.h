...
@interface WebDefaultEditingDelegate : NSObject {
 ...
 - (BOOL) webView:(id)ashouldInsertNode:(id)breplacingDOMRange:(id)cgivenAction:(long long)d;
 - (BOOL) webView:(id)ashouldInsertText:(id)breplacingDOMRange:(id)cgivenAction:(long long)d;
 - (BOOL) webView:(id)ashouldDeleteDOMRange:(id)b;
 - (BOOL) webView:(id)ashouldChangeSelectedDOMRange:(id)btoDOMRange:(id)caffinity:(int)dstillSelecting:(BOOL)e;
