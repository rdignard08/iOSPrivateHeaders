...
@property (nonatomic, assign, readonly) JSContext* javaScriptContext;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) caretRectAtNode:(id)aoffset:(i)baffinity:(i)c;
 - (void) setText:(id)aasChildOfElement:(id)b;
 - (void) setSelectedDOMRange:(id)aaffinity:(i)bcloseTyping:(BOOL)c;
 - (void) setIsActive:(BOOL)a;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) firstRectForDOMRange:(id)a;
 - (void) setSelectionGranularity:(i)a;
 - (void) clearSelection;
 ...
 - (void) sendOrientationChangeEvent:(i)a;
 ...
 - (id) webView;
 - (void) setNeedsLayout;
 - (void) setBaseWritingDirection:(i)a;
 ...
 - (i) numberOfPagesWithPageWidth:(f)apageHeight:(f)b;
 - (void) printToCGContext:(^{CGContext=})apageWidth:(f)bpageHeight:(f)c;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _caretRectAtPosition:(r^{Position={RefPtr<WebCore::Node>=^{Node}}ib3b1})aaffinity:(i)b;
 - (void) _scrollDOMRangeToVisible:(id)a;
 - (void) _scrollDOMRangeToVisible:(id)awithInset:(d)b;
 - (BOOL) _needsLayout;
 - (i) _selectionGranularity;
 ...
 - (id) _typingStyle;
 - (void) _setTypingStyle:(id)awithUndoAction:(i)b;
 ...
 - (void) _setTextAutosizingWidth:(d)a;
 ...
 - (I) _pendingFrameUnloadEventCount;
 - (I) formElementsCharacterCount;
 - (void) setTimeoutsPaused:(BOOL)a;
 - (void) selectNSRange:({_NSRange=QQ})a;
 - ({_NSRange=QQ}) selectedNSRange;
 - (void) _restoreViewState;
 - (void) _saveViewState;
 - ({CGSize=dd}) renderedSizeOfNode:(id)aconstrainedToWidth:(f)b;
 - (i) preferredHeight;
 ...
 - (void) _clearOpener;
 - (id) _computePageRectsWithPrintScaleFactor:(f)apageSize:({CGSize=dd})b;
 ...
 - (i) selectionBaseWritingDirection;
 ...
 - (BOOL) renderedCharactersExceed:(Q)a;
