...
@property (nonatomic, assign, readonly) JSContext* javaScriptContext;
 ...
 - (void) setDictationPhrases:(id)a metadata:(id)b asChildOfElement:(id)c ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) rectForScrollToVisible;
 - (id) convertNSRangeToDOMRange:({_NSRange=QQ})a ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) caretRectAtNode:(id)a offset:(int)b affinity:(int)c ;
 - (void) setText:(id)a asChildOfElement:(id)b ;
 - (void) setSelectedDOMRange:(id)a affinity:(int)b closeTyping:(BOOL)c ;
 ...
 - (void) getDictationResultRanges:(^@)a andMetadatas:(^@)b ;
 ...
 - (void) _replaceSelectionWithWebArchive:(id)a selectReplacement:(BOOL)b smartReplace:(BOOL)c ;
 ...
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) renderRectForPoint:({CGPoint=dd})a isReplaced:(^B)b fontSize:(^f)c ;
 ...
 - (int) numberOfPagesWithPageWidth:(float)a pageHeight:(float)b ;
 - (void) printToCGContext:(^{CGContext=})a pageWidth:(float)b pageHeight:(float)c ;
 - (void) _replaceSelectionWithFragment:(id)a selectReplacement:(BOOL)b smartReplace:(BOOL)c matchStyle:(BOOL)d ;
 - (id) _documentFragmentWithMarkupString:(id)a baseURLString:(id)b ;
 ...
 - (id) _initWithWebFrameView:(id)a webView:(id)b ;
 - (BOOL) _hasSelection;
 - (id) _findFrameWithSelection;
 - (void) _clearSelection;
 - (BOOL) _shouldFlattenCompositingLayers:(^{CGContext=})a ;
 - (id) _stringByEvaluatingJavaScriptFromString:(id)a forceUserGesture:(BOOL)b ;
 ...
 - (void) _drawRect:({CGRect={CGPoint=dd}{CGSize=dd}})a contentsOnly:(BOOL)b ;
 - (BOOL) _getVisibleRect:(^{CGRect={CGPoint=dd}{CGSize=dd}})a ;
 - (id) _stringByEvaluatingJavaScriptFromString:(id)a ;
 - ({CGRect={CGPoint=dd}{CGSize=dd}}) _caretRectAtPosition:(r^{Position={RefPtr<WebCore::Node>=^{Node}}ib3b1})a affinity:(int)b ;
 - (void) _scrollDOMRangeToVisible:(id)a ;
 - (void) _scrollDOMRangeToVisible:(id)a withInset:(double)b ;
 - (BOOL) _needsLayout;
 ...
 - (void) _replaceSelectionWithNode:(id)a selectReplacement:(BOOL)b smartReplace:(BOOL)c matchStyle:(BOOL)d ;
 ...
 - (id) _typingStyle;
 - (void) _setTypingStyle:(id)a withUndoAction:(int)b ;
 ...
 - (id) _selectionRangeForFirstPoint:({CGPoint=dd})a secondPoint:({CGPoint=dd})b ;
 ...
 - (void) _saveViewState;
 - ({CGSize=dd}) renderedSizeOfNode:(id)a constrainedToWidth:(float)b ;
 - (int) preferredHeight;
 ...
 - (void) selectNSRange:({_NSRange=QQ})a onElement:(id)b ;
 - (void) setMarkedText:(id)a selectedRange:({_NSRange=QQ})b ;
 - (void) setMarkedText:(id)a forCandidates:(BOOL)b ;
 - (id) stringByEvaluatingJavaScriptFromString:(id)a forceUserGesture:(BOOL)b ;
 - (void) _replaceSelectionWithText:(id)a selectReplacement:(BOOL)b smartReplace:(BOOL)c matchStyle:(BOOL)d ;
 - (void) _replaceSelectionWithText:(id)a selectReplacement:(BOOL)b smartReplace:(BOOL)c ;
 - (void) _replaceSelectionWithMarkupString:(id)a baseURLString:(id)b selectReplacement:(BOOL)c smartReplace:(BOOL)d ;
 - (id) _cacheabilityDictionary;
 - (BOOL) _allowsFollowingLink:(id)a ;
 - (id) _stringByEvaluatingJavaScriptFromString:(id)a withGlobalObject:(^{OpaqueJSValue=})b inScriptWorld:(id)c ;
 ...
 - (void) _clearOpener;
 - (id) _computePageRectsWithPrintScaleFactor:(float)a pageSize:({CGSize=dd})b ;
 - (id) _documentFragmentForText:(id)a ;
 - (id) _documentFragmentForWebArchive:(id)a ;
 - (id) _documentFragmentForImageData:(id)a withRelativeURLPart:(id)b andMIMEType:(id)c ;
 - (^{OpaqueJSValue=}) jsWrapperForNode:(id)a inScriptWorld:(id)b ;
 - (id) elementAtPoint:({CGPoint=dd})a ;
 - (id) _unreachableURL;
 - (void) _loadData:(id)a MIMEType:(id)b textEncodingName:(id)c baseURL:(id)d unreachableURL:(id)e ;
 - (void) _loadHTMLString:(id)a baseURL:(id)b unreachableURL:(id)c ;
 - (id) initWithName:(id)a webFrameView:(id)b webView:(id)c ;
 - (id) frameElement;
 - (id) provisionalDataSource;
 - (void) loadRequest:(id)a ;
 - (void) loadAlternateHTMLString:(id)a baseURL:(id)b forUnreachableURL:(id)c ;
 - (void) reload;
 ...
 - (BOOL) hasSelection;
 - (BOOL) setSelectionWithBasePoint:({CGPoint=dd})a extentPoint:({CGPoint=dd})b baseIsStart:(BOOL)c allowFlipping:(BOOL)d ;
 ...
 - (BOOL) setSelectionWithBasePoint:({CGPoint=dd})a extentPoint:({CGPoint=dd})b baseIsStart:(BOOL)c ;
 - (void) ensureRangedSelectionContainsInitialStartPoint:({CGPoint=dd})a initialEndPoint:({CGPoint=dd})b ;
 - (void) expandSelectionToSentence;
 - (BOOL) renderedCharactersExceed:(unsigned long long)a ;
 - (^{CGImage=}) imageForNode:(id)a allowDownsampling:(BOOL)b drawContentBehindTransparentNodes:(BOOL)c ;
