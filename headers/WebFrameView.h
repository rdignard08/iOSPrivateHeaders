...
@interface WebFrameView : WAKView <WebCoreFrameView> {
 ...
 - (void) _install;
 - (f) _verticalKeyboardScrollDistance;
 - (id) _contentView;
 - (f) _verticalPageScrollDistance;
 - (void) _frameSizeChanged;
 - (void) setNextKeyView:(id)a;
 - (BOOL) _scrollOverflowInDirection:(Q)agranularity:(Q)b;
 - (BOOL) _isScrollable;
 ...
 - (BOOL) _scrollVerticallyBy:(f)a;
 - (BOOL) _pageHorizontally:(BOOL)a;
 - (f) _horizontalPageScrollDistance;
 - (BOOL) _scrollHorizontallyBy:(f)a;
 - (BOOL) _scrollLineVertically:(BOOL)a;
 - (BOOL) _scrollLineHorizontally:(BOOL)a;
 - (f) _horizontalKeyboardScrollDistance;
