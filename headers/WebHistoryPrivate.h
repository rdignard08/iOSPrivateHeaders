...
@interface WebHistoryPrivate : NSObject {
 ...
 - (id) init;
 - (id) itemForURL:(id)a ;
 - (BOOL) findKey:(^q)a forDay:(double)b ;
 - (BOOL) removeItemFromDateCaches:(id)a ;
 - (void) insertItem:(id)a forDateKey:(long long)b ;
 - (void) addItemToDateCaches:(id)a ;
 - (BOOL) removeItemForURLString:(id)a ;
 - (BOOL) addItem:(id)a discardDuplicate:(BOOL)b ;
 - (id) itemForURLString:(id)a ;
 - (int) historyAgeInDaysLimit;
 - (int) historyItemLimit;
 - (id) ageLimitDate;
 - (BOOL) loadHistoryGutsFromURL:(id)a savedItemsCount:(^i)b collectDiscardedItemsInto:(id)c error:(^@)d ;
 - (id) visitedURL:(id)a withTitle:(id)b ;
 ...
 - (BOOL) loadFromURL:(id)a collectDiscardedItemsInto:(id)b error:(^@)c ;
 - (BOOL) saveToURL:(id)a error:(^@)b ;
