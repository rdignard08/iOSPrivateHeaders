...
@property (nonatomic, assign, readwrite) NSNumber* suppressesIncrementalRendering;
 ...
 - (void) _setIntegerValue:(int)aforKey:(id)b;
 - (void) _setBoolValue:(BOOL)aforKey:(id)b;
 - (void) setAutomaticallyDetectsCacheModel:(BOOL)a;
 - (void) _setUnsignedIntValue:(unsigned int)aforKey:(id)b;
 - (void) _setFloatValue:(float)aforKey:(id)b;
 - (void) _setLongLongValue:(long long)aforKey:(id)b;
 - (void) _setUnsignedLongLongValue:(unsigned long long)aforKey:(id)b;
