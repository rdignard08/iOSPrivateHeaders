...
@property (nonatomic, copy, readonly) NSString* frameName;
 ...
 - (id) textEncodingName;
 - (id) _initWithData:(id)a URL:(id)b MIMEType:(id)c textEncodingName:(id)d frameName:(id)e response:(id)f copyData:(BOOL)g ;
 - (void) _ignoreWhenUnarchiving;
 - (id) _initWithData:(id)a URL:(id)b response:(id)c ;
