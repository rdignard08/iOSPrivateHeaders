...
@interface WebView : WAKView {
 ...
 + (BOOL) isCharacterSmartReplaceExempt:(S)aisPreviousCharacter:(BOOL)b;
 + (void) _setPDFRepresentationClass:(Class)a;
 + (void) _setPDFViewClass:(Class)a;
 + (Q) _cacheModel;
 + (void) _setCacheModel:(Q)a;
 ...
 + (void) _addUserScriptToGroup:(id)aworld:(id)bsource:(id)curl:(id)dwhitelist:(id)eblacklist:(id)finjectionTime:(i)ginjectedFrames:(i)h;
 + (void) _addUserStyleSheetToGroup:(id)aworld:(id)bsource:(id)curl:(id)dwhitelist:(id)eblacklist:(id)finjectedFrames:(i)g;
 ...
 + (void) _addUserScriptToGroup:(id)aworld:(id)bsource:(id)curl:(id)dwhitelist:(id)eblacklist:(id)finjectionTime:(i)g;
 ...
 + (void) _setTileCacheLayerPoolCapacity:(I)a;
 ...
 - (BOOL) _setMediaLayer:(id)aforPluginView:(id)b;
 ...
 - (void) _setCustomFixedPositionLayoutRectInWebThread:({CGRect={CGPoint=dd}{CGSize=dd}})asynchronize:(BOOL)b;
 - (void) _setCustomFixedPositionLayoutRect:({CGRect={CGPoint=dd}{CGSize=dd}})a;
 - (id) editingDelegate;
 - (void) insertDictationPhrases:(id)ametadata:(id)b;
 ...
 - (void) _overflowScrollPositionChangedTo:({CGPoint=dd})aforNode:(id)bisUserScroll:(BOOL)c;
 - (id) _touchEventRegions;
 - (BOOL) defersCallbacks;
 - (void) _setHostApplicationProcessIdentifier:(i)aauditToken:({?=[8I]})b;
 ...
 - (void) setTextSizeMultiplier:(f)a;
 - (f) textSizeMultiplier;
 ...
 - (void) _closeWindow;
 - (void) _mouseDidMoveOverElement:(id)amodifierFlags:(Q)b;
 ...
 - (BOOL) _shouldChangeSelectedDOMRange:(id)atoDOMRange:(id)baffinity:(i)cstillSelecting:(BOOL)d;
 - (BOOL) _isClosing;
 - (id) undoManager;
 - (void) moveUp:(id)a;
 - (void) moveDown:(id)a;
 ...
 - (f) _realZoomMultiplier;
 - (BOOL) _realZoomMultiplierIsTextOnly;
 - (void) _setZoomMultiplier:(f)aisTextOnly:(BOOL)b;
 ...
 - (void) _addObject:(id)aforIdentifier:(Q)b;
 - (id) _objectForIdentifier:(Q)a;
 - (void) _removeObjectForIdentifier:(Q)a;
 ...
 - (void) _commonInitializationWithFrameName:(id)agroupName:(id)b;
 ...
 - (void) _locked_recursivelyPerformPlugInSelector:(SEL)ainFrame:(id)b;
 - (id) backForwardList;
 - (void) _synchronizeCustomFixedPositionLayoutRect;
 - (Q) countMatchesForText:(id)aoptions:(Q)bhighlight:(BOOL)climit:(Q)dmarkMatches:(BOOL)e;
 - (BOOL) findString:(id)aoptions:(Q)b;
 - (id) currentNodeHighlight;
 - (void) _setBrowserUserAgentProductVersion:(id)abuildVersion:(id)bbundleVersion:(id)c;
 - (void) _dispatchPendingLoadRequests;
 - (id) _initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})aframeName:(id)bgroupName:(id)c;
 - (void) _viewWillDrawInternal;
 - (void) _replaceCurrentHistoryItem:(id)a;
 - (void) updateLayoutIgnorePendingStyleSheets;
 - (BOOL) _viewClass:(^#)aandRepresentationClass:(^#)bforMIMEType:(id)c;
 - (BOOL) _isClosed;
 ...
 - (void) _executeCoreCommandByName:(id)avalue:(id)b;
 ...
 - (void) _setBaseCTM:({CGAffineTransform=dddddd})aforContext:(^{CGContext=})b;
 - (void) setInteractiveFormValidationEnabled:(BOOL)a;
 - (void) setValidationMessageTimerMagnification:(i)a;
 ...
 - (void) _scaleWebView:(f)aatOrigin:({CGPoint=dd})b;
 - (f) _viewScaleFactor;
 - (void) _setUseFixedLayout:(BOOL)a;
 - (void) _listenForLayoutMilestones:(Q)a;
 - (Q) _layoutMilestones;
 - (i) _visibilityState;
 - (void) _setVisibilityState:(i)aisInitialState:(BOOL)b;
 - (Q) markAllMatchesForText:(id)acaseSensitive:(BOOL)bhighlight:(BOOL)climit:(Q)d;
 - (Q) countMatchesForText:(id)acaseSensitive:(BOOL)bhighlight:(BOOL)climit:(Q)dmarkMatches:(BOOL)e;
 - (BOOL) _wantsTelephoneNumberParsing;
 - (BOOL) _webGLEnabled;
 - (void) _setWebGLEnabled:(BOOL)a;
 - (void) _setSourceApplicationAuditData:(id)a;
 - (id) initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})aframeName:(id)bgroupName:(id)c;
 - (id) frameLoadDelegate;
 - (id) _focusedFrame;
 - (f) _zoomMultiplier:(BOOL)a;
 ...
 - (void) _zoomOut:(id)aisTextOnly:(BOOL)b;
 - (void) _zoomIn:(id)aisTextOnly:(BOOL)b;
 - (BOOL) _canResetZoom:(BOOL)a;
 - (void) _resetZoom:(id)aisTextOnly:(BOOL)b;
 ...
 - (Q) countMatchesForText:(id)ainDOMRange:(id)boptions:(Q)chighlight:(BOOL)dlimit:(Q)emarkMatches:(BOOL)f;
 - (id) DOMRangeOfString:(id)arelativeTo:(id)boptions:(Q)c;
 ...
 - (void) scrollDOMRangeToVisible:(id)awithInset:(d)b;
 - (BOOL) allowsUndo;
 - (void) setAllowsUndo:(BOOL)a;
 - (void) setPageSizeMultiplier:(f)a;
 - (f) pageSizeMultiplier;
 - (BOOL) canZoomPageIn;
 ...
 - (void) setMediaVolume:(f)a;
 - (f) mediaVolume;
 - (void) addVisitedLinks:(id)a;
 - (void) removeVisitedLink:(id)a;
 - (id) computedStyleForElement:(id)apseudoElement:(id)b;
 - (BOOL) _continuousCheckingAllowed;
 - (void) registerForEditingDelegateNotification:(id)aselector:(SEL)b;
 ...
 - (void) _performResponderOperation:(SEL)awith:(id)b;
 ...
 - (void) _replaceSelectionWithNode:(id)amatchStyle:(BOOL)b;
 - (BOOL) _selectionIsCaret;
 - (BOOL) _selectionIsAll;
 - (void) _simplifyMarkup:(id)aendNode:(id)b;
 ...
 - (void) _notificationDidShow:(Q)a;
 - (void) _notificationDidClick:(Q)a;
 - (void) _notificationsDidClose:(id)a;
 - (Q) _notificationIDForTesting:(^{OpaqueJSValue=})a;
