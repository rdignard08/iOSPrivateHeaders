...
@interface WebView : WAKView {
 ...
 - (void) _setHostApplicationProcessIdentifier:(int)aauditToken:({?=[8I]})b;
 ...
 - (void) _closeWindow;
 - (void) _mouseDidMoveOverElement:(id)amodifierFlags:(unsigned long long)b;
 ...
 - (BOOL) _shouldChangeSelectedDOMRange:(id)atoDOMRange:(id)baffinity:(int)cstillSelecting:(BOOL)d;
 - (BOOL) _isClosing;
 - (id) undoManager;
 - (void) moveUp:(id)a;
 - (void) moveDown:(id)a;
 ...
 - (void) _setZoomMultiplier:(float)aisTextOnly:(BOOL)b;
 ...
 - (void) _addObject:(id)aforIdentifier:(unsigned long long)b;
 ...
 - (unsigned long long) countMatchesForText:(id)aoptions:(unsigned long long)bhighlight:(BOOL)climit:(unsigned long long)dmarkMatches:(BOOL)e;
 - (BOOL) findString:(id)aoptions:(unsigned long long)b;
 ...
 - (void) _scaleWebView:(float)aatOrigin:({CGPoint=dd})b;
 ...
 - (void) _setVisibilityState:(int)aisInitialState:(BOOL)b;
 - (unsigned long long) markAllMatchesForText:(id)acaseSensitive:(BOOL)bhighlight:(BOOL)climit:(unsigned long long)d;
 - (unsigned long long) countMatchesForText:(id)acaseSensitive:(BOOL)bhighlight:(BOOL)climit:(unsigned long long)dmarkMatches:(BOOL)e;
 ...
 - (unsigned long long) countMatchesForText:(id)ainDOMRange:(id)boptions:(unsigned long long)chighlight:(BOOL)dlimit:(unsigned long long)emarkMatches:(BOOL)f;
 - (id) DOMRangeOfString:(id)arelativeTo:(id)boptions:(unsigned long long)c;
 ...
 - (void) scrollDOMRangeToVisible:(id)awithInset:(double)b;
 - (BOOL) allowsUndo;
