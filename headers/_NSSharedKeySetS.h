...
@property (atomic, retain, readwrite) _NSSharedKeySetS* subSharedKeySet;
 ...
 - (unsigned long long) indexForBytes:(char*)a length:(unsigned long long)b ;
 ...
 - (id) initWithKeys:(^^v)a keyLenghtInBytes:(unsigned int)b count:(unsigned int)c type:(unsigned int)d ;
 - (^S) keyAtIndex:(unsigned long long)a ;
 - (char*) bytesAtIndex:(unsigned long long)a ;
 - (unsigned int) keyLen;
 - (unsigned long long) indexForKey:(^S)a length:(unsigned long long)b ;
 - (unsigned int) maximumIndex;
 - (id) newKeySetWithKeys:(id)a encoding:(unsigned int)b ;
 - (char*) g;
