...
@interface _UIAlertControllerView : UIView <UICollectionViewDataSource, UICollectionViewDelegate, UIScrollViewDelegate> {
 ...
 - (d) _labelHorizontalInsets;
 - ({CGSize=dd}) _sizeForLayoutWidthDetermination;
 - (BOOL) _horizontalLayoutCanUseFullWidth;
 - (d) _verticalLayoutWidth;
 - (d) _availableWidthForHorizontalLayout:(BOOL)a;
 - (BOOL) _wantsHorizontalActionSheet;
 - (q) _numberOfActionsForCollectionView;
 - (d) _idealLayoutWidth;
 ...
 - (d) _layoutWidthForHorizontalLayout:(BOOL)a;
 ...
 - (d) _marginBetweenContentAndDiscreteCancelAction;
