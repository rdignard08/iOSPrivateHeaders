...
@interface _UIBackdropView : UIView {
 ...
 - (id) initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})aprivateStyle:(long long)b;
 ...
 - (void) updateMaskViewForView:(id)aflag:(long long)b;
 - (id) gaussianBlurFilter;
 - (id) colorSaturateFilter;
 - (id) tintFilter;
 - (BOOL) blurRadiusSetOnce;
 - (void) setBlurRadiusSetOnce:(BOOL)a;
 - (void) setBlurFilterWithRadius:(double)ablurQuality:(id)b;
 - (void) setBlurFilterWithRadius:(double)ablurQuality:(id)bblurHardEdges:(long long)c;
 ...
 - (void) transitionIncrementallyToSettings:(id)aweighting:(double)b;
 - (void) transitionIncrementallyToStyle:(long long)aweighting:(double)b;
 ...
 - (void) applyOverlayBlendMode:(long long)atoView:(id)b;
 - (void) setUsesZoom;
 - (void) _setBlursBackground:(BOOL)a;
 - (void) transitionToColor:(id)a;
 - (void) transitionIncrementallyToPrivateStyle:(long long)aweighting:(double)b;
