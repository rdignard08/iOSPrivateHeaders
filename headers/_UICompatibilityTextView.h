...
@interface _UICompatibilityTextView : UIScrollView <UITextLinkInteraction, UITextInput> {
 ...
 - (void) _updateForNewSize:({CGSize=dd})a withOldSize:({CGSize=dd})b ;
 - (BOOL) shouldStartDataDetectors;
 - (void) startDataDetectorsWithWebLock;
 - (void) _transferAttribute:(id)a fromString:(id)b andSetPropertyWith:(SEL)c usingValueClass:(Class)d ;
