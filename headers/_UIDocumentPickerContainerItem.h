...
@property (nonatomic, copy, readwrite) NSString* pickabilityReason;
 ...
 - (id) parentModel;
 - (id) _createThumbnailWithSize:({CGSize=dd})ascale:(double)b;
 - (id) _blockingThumbnailWithSize:({CGSize=dd})ascale:(double)b;
 - (id) _resourceIdentifier;
 - (id) _blipWithTags:(id)aheight:(double)bscale:(double)c;
 - (id) sortDate;
 - (void) _ensureModelPresent;
 - (void) _modelChanged;
 - (id) thumbnailWithSize:({CGSize=dd})ascale:(double)b;
 - (id) subtitle;
 - (id) subtitle2;
 - (id) model;
 - (id) tagBlipsWithHeight:(double)ascale:(double)b;
 - (id) sortTag;
