...
@property (nonatomic, weak, readwrite) NSNumber* updateHandlerWeakSelf;
 ...
 - (id) metadataQuery:(id)areplacementObjectForResultObject:(id)b;
 ...
 - (Class) itemClass;
 - (void) _updateObservers:(id)areloadAll:(BOOL)b;
 - (void) setQuery:(id)a;
 - (id) queryWorkerQueue;
 - (id) scopes;
 ...
 - (id) _queryResults;
 - (void) _processResults:(id)achangedItems:(id)breloadAll:(BOOL)c;
 - (id) lastSnapshotDate;
 - (id) _computeUpdatesFromOld:(id)atoNew:(id)bchangedItems:(id)c;
 - (void) setLastSnapshot:(id)a;
 - (void) setLastSnapshotDate:(id)a;
 - (void) setAfterInitialUpdate:(BOOL)a;
 - (id) updateHandlerWeakSelf;
 - (id) initWithScopes:(id)aweakSelf:(id)bupdateHandler:(@?)citemClass:(Class)d;
