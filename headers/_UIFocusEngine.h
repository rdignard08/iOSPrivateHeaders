...
@property (nonatomic, assign, readwrite, _playsSoundOnFocusChange, _setPlaysSoundOnFocusChange:) NSNumber* playsSoundOnFocusChange;
 ...
 - (BOOL) moveInDirection:(Q)a;
 - (void) setMoveEvent:(id)a;
 - ({CGSize=dd}) _vectorForFocusHeading:(Q)a;
 - (id) _focusedView;
 - (id) _bestFocusCandidateForFocusHeading:(Q)acurrentFocusView:(id)bdirection:({CGSize=dd})cinView:(id)d;
 ...
 - (i) _touchRegionForDigitizerLocation:({CGPoint=dd})a;
