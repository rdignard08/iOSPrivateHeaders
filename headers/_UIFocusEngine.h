...
@property (nonatomic, assign, readwrite, getter=_sendsFocusDirection, setter=_setSendsFocusDirection:) NSNumber* sendsFocusDirection;
@property (nonatomic, assign, readwrite, getter=_playsSoundOnFocusChange, setter=_setPlaysSoundOnFocusChange:) NSNumber* playsSoundOnFocusChange;
 + (void) initialize;
 ...
 - (id) _focusedView;
 - (id) _bestFocusCandidateForFocusHeading:(unsigned long long)a currentFocusView:(id)b direction:({CGSize=dd})c inView:(id)d ;
 - (void) _updateFocusedViewAndScroll:(id)a ;
 - (void) _resetFocusDirectionRollback;
 - (void) _resetMomentum;
 - (void) _panGestureStart:(id)a ;
 - (void) _panGestureUpdate:(id)a atLocation:({CGPoint=dd})b reportedVelocity:({CGPoint=dd})c ;
 ...
 - (void) _updateScrollView:(id)a visibleBounds:({CGRect={CGPoint=dd}{CGSize=dd}})b ;
 - (void) _loadScrollViewContentInDirection:({CGSize=dd})a fromView:(id)b ;
 - (id) _bestFocusCandidateStartingAtView:(id)a inDirection:({CGSize=dd})b inView:(id)c ;
 - (void) _setFocusedView:(id)a ;
 - (void) _scrollFromView:(id)a toView:(id)b ;
 - (BOOL) _playsSoundOnFocusChange;
 - (void) _playTickSound;
 - (void) _sendGestureBeginNotification;
 - ({CGSize=dd}) _touchSensitivityForView:(id)a ;
 - (void) _updateDebugOverlayWithTouchAtNormalizedPoint:({CGPoint=dd})a navigationBoundary:({CGRect={CGPoint=dd}{CGSize=dd}})b ;
 ...
 - ({CGPoint=dd}) _contentOffsetForScrollView:(id)a toFocusView:(id)b ;
 - (void) _setupDebugOverlays;
 - (void) _teardownDebugOverlays;
 - (id) _closestFocusableViewToRect:({CGRect={CGPoint=dd}{CGSize=dd}})a inView:(id)b ;
 ...
 - (id) _closestFocusableViewToPoint:({CGPoint=dd})a inView:(id)b ;
 - (id) targetWindow;
