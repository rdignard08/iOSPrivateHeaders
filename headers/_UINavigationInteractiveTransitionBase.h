...
@interface _UINavigationInteractiveTransitionBase : UIPercentDrivenInteractiveTransition <UIGestureRecognizerDelegate> {
 ...
 - (void) _updateStatistics:(id)a firstSample:(BOOL)b finalSample:(BOOL)c ;
 - (BOOL) springAnimationIsPending;
 - (BOOL) popGesture:(id)a withRemainingDuration:(double)b shouldPopWithVelocity:(^d)c ;
 ...
 - (id) initWithGestureRecognizerView:(id)a animator:(id)b delegate:(id)c ;
