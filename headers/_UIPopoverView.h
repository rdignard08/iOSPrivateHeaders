...
@interface _UIPopoverView : UIView {
 ...
 - (id) initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a backgroundViewClass:(Class)b embeddedInView:(BOOL)c ;
 - (id) standardChromeView;
 - (id) initWithFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a backgroundViewClass:(Class)b ;
 ...
 - (void) _setFrame:({CGRect={CGPoint=dd}{CGSize=dd}})a arrowOffset:(double)b ;
