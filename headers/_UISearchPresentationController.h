...
@interface _UISearchPresentationController : UIPresentationController <_UISearchControllerPresenting> {
 ...
 - (void) _transitionToPresentationController:(id)a withTransitionCoordinator:(id)b ;
 - (id) _presentationControllerForTraitCollection:(id)a ;
 - (id) _presentedViewControllerForPresentationController:(id)a traitCollection:(id)b ;
 ...
 - (void) _updatePresentingViewControllerContentScrollViewWithOffsets:({CGSize=dd})a transitionCoordinator:(id)b ;
