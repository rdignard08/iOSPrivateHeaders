...
@property (atomic, assign, readwrite) NSNumber* delegate;
 ...
 - (void) __prototype_requestConnectionToDeputyFromHostObject:(id)a replyHandler:(@?)b ;
 - (void) checkDeputyForRotation:(id)a ;
 - (void) __requestConnectionToDeputyOfClass:(Class)a fromHostObject:(R)b replyHandler:(id)c ;
