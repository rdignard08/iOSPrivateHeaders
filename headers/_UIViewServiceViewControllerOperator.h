...
@interface _UIViewServiceViewControllerOperator : UIViewController <_UIViewServiceViewControllerOperator_RemoteViewControllerInterface, _UIHostedTextServiceSessionDelegate, _UIViewServiceDummyPopoverControllerDelegate, _UIViewServiceDeputy, _UIViewServiceDeputyRotationSource> {
    ...
    q _hostStatusBarOrientation;
    d _hostStatusBarHeight;
    @"NSMutableArray" _deputyRotationDelegates;
    I _hostAccessibilityServerPort;
 ...
 + (id) XPCInterface;
 + (id) operatorWithRemoteViewControllerProxy:(id)ahostPID:(i)bhostBundleID:(id)chostAuditToken:({?=[8I]})d;
 ...
 - (void) __createViewController:(id)awithContextToken:(id)bfbsDisplays:(id)cappearanceSerializedRepresentations:(id)dlegacyAppearance:(BOOL)etraitCollection:(id)finitialInterfaceOrientation:(q)ghostAccessibilityServerPort:(id)hcanShowTextServices:(BOOL)ireplyHandler:(@?)j;
 - (void) __hostReadyToReceiveMessagesFromServiceViewController;
 - (void) _firstResponderDidChange:(id)a;
 - (void) __hostDidChangeStatusBarOrientationToInterfaceOrientation:(q)a;
 - (void) __hostDidChangeStatusBarHeight:(d)a;
 ...
 - (void) __hostedActionSheetDidDismissWithClickedButtonIndex:(q)a;
 - (void) __hostedActionSheetClickedButtonAtIndex:(q)a;
 - (void) __hostDisablesAutomaticKeyboardBehavior:(BOOL)a;
 - (void) __hostViewWillAppear:(BOOL)ainInterfaceOrientation:(q)btraitCollection:(id)cstatusBarHeight:(d)dcompletionHandler:(@?)e;
 - (void) __hostViewDidMoveToScreenWithIntegerDisplayID:(I)anewHostingHandleReplyHandler:(@?)b;
 ...
 - (void) __hostViewWillTransitionToSize:({CGSize=dd})awithContextDescription:(id)bstatusBarHeight:(d)cwhenDone:(@?)d;
 - (void) __hostWillAnimateRotationToInterfaceOrientation:(q)aduration:(d)bskipSelf:(BOOL)c;
 - (void) __hostWillRotateToInterfaceOrientation:(q)aduration:(d)bskipSelf:(BOOL)c;
 - (void) __hostDidRotateFromInterfaceOrientation:(q)askipSelf:(BOOL)b;
 ...
 - (void) __setHostTintColor:(id)atintAdjustmentMode:(q)b;
 ...
 - (id) _inputViewsKey;
 - (BOOL) _presentActionSheet:(id)aasPopoverFromBarButtonItem:(id)borFromRect:({CGRect={CGPoint=dd}{CGSize=dd}})cinView:(id)dwithPreferredArrowDirections:(Q)epassthroughViews:(id)fbackgroundStyle:(q)ganimated:(BOOL)h;
 - (void) _dismissActionSheet:(id)awithClickedButtonIndex:(q)banimated:(BOOL)c;
