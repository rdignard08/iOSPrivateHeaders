...
@property (atomic, assign, readwrite) NSNumber* delegateQueue;
 ...
 - (void) cancel;
 - (id) initWithTask:(id)a delegate:(id)b delegateQueue:(id)c ;
 ...
 - (void) _didReceiveResponse:(id)a sniff:(BOOL)b ;
 ...
 - (void) _setupForCache:(BOOL)a expectedLength:(long long)b response:(id)c ;
 ...
 - (void) _willSendRequestForEstablishedConnection:(id)a completion:(@?)b ;
 - (void) _connectionIsWaitingWithReason:(long long)a ;
 - (void) _conditionalRequirementsChanged:(BOOL)a ;
 - (void) _redirectRequest:(id)a redirectResponse:(id)b completion:(@?)c ;
