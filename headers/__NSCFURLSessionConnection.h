...
@interface __NSCFURLSessionConnection : NSObject <NSURLAuthenticationChallengeSender, NSCopying> {
    ...
    q _pendingCompletion;
    Q _didReceiveResponseDisposition;
    @"NSError" _pendingError;
    i _state;
    @"NSURLResponse" _cacheResponse;
    @"NSObject<OS_dispatch_data>" _cacheData;
    Q _cacheDataMax;
    q _clientBufferLength;
...
@property (atomic, assign, readwrite) NSNumber* delegateQueue;
 ...
 - (void) suspend;
 - (void) setPoolPriority:(q)a;
 - (void) setPriorityHint:(f)a;
 - (void) setTask:(id)a;
 - (id) delegateQueue;
 ...
 - (void) _setupForCache:(BOOL)aexpectedLength:(q)bresponse:(id)c;
 ...
 - (void) _connectionIsWaitingWithReason:(q)a;
