...
@property (atomic, copy, readwrite) NSDictionary* _backgroundTaskTimingData;
 ...
 - (id) initWithTask:(id)a bundleID:(id)b sessionID:(id)c ;
 ...
 - (id) initWithDataTask:(id)a bundleID:(id)b sessionID:(id)c ;
 - (id) initWithUploadTask:(id)a bundleID:(id)b sessionID:(id)c ;
 - (id) initWithDownloadTask:(id)a bundleID:(id)b sessionID:(id)c ;
 - (id) initWithAVAssetDownloadURL:(id)a destinationURL:(id)b options:(id)c taskIdentifier:(unsigned long long)d bundleID:(id)e sessionID:(id)f ;
