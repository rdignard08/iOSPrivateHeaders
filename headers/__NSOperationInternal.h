...
@interface __NSOperationInternal : NSObject {
 ...
 - (BOOL) _isFinished;
 - (BOOL) _isReady;
 - (void) _setQueuePriority:(long long)a outer:(id)b ;
 - (double) _threadPriority;
 - (void) _setThreadPriority:(double)a outer:(id)b ;
 - (@?) _completionBlock;
 - (void) _setCompletionBlock:(@?)a outer:(id)b ;
 - (id) _name;
 - (void) _setName:(id)a outer:(id)b ;
 - (void) _waitUntilFinished:(id)a ;
 - (void) _waitUntilFinishedOrTimeout:(double)a outer:(id)b ;
 - (void) _addDependency:(id)a outer:(id)b ;
 - (void) _removeDependency:(id)a outer:(id)b ;
 - (id) _dependencies;
 - (void) _start:(id)a ;
 - (id) __;
 - (void) dealloc;
